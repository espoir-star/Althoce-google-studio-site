  ...
  "@graph": [
    {
      ...
      "description": "Chatbot IA RAG ancré sur votre base de connaissances (FAQ, docs, intranet). Souverain, français, intégrable à votre site ou intranet. Chiffré sur mesure.",
      "offers": {
        "@type": "Offer",
        "url": "https://althoce.com/services/chatbot-ia/"
      }
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        { "@type": "Question", "name": "Combien coûte un chatbot IA ?", "acceptedAnswer": { "@type": "Answer", "text": "Le chiffrage dépend du volume de votre base de connaissances, du nombre de sources à indexer et des actions que le chatbot doit déclencher. 30 min offertes." } },
