  ...
  return (
    <section style={{ padding: '120px 24px 80px', position: 'relative', overflow: 'hidden', borderBottom: '1px solid #e4e4e7' }}>
      <div aria-hidden="true" style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
        <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: 600, height: 600, borderRadius: '50%', background: `radial-gradient(circle,${AC}0a 0%,transparent 65%)`, filter: 'blur(80px)', animation: 'nan-drift 14s ease-in-out infinite' }} />
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1160, margin: '0 auto' }}>
        <div className="nan-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            <nav aria-label="Breadcrumb" style={{ fontSize: 13, color: '#a1a1aa', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', fontWeight: 500 }}>
              ...
              <span style={{ color: '#09090b' }}>Nantes</span>
            </nav>
            ...
            <h1 style={{ fontSize: 'clamp(26px,3.8vw,50px)', fontWeight: 800, lineHeight: 1.08, letterSpacing: '-.04em', color: '#09090b', marginBottom: 20 }}>
              Agence IA à Nantes : agents IA, automatisation et formation pour PME et ETI nantaises.
            </h1>

            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 32, maxWidth: 520 }}>
              Vous dirigez une PME ou une ETI à Nantes, dans la métropole ou en Pays de la Loire. Althoce vous accompagne avec une expertise sur les secteurs forts régionaux (numérique, biotech, agroalimentaire), une présence régionale et un distanciel structuré pour la phase de build.
            </p>
          ...
          <div className="nan-map-col" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <FranceMapSVG mainCity="Nantes" presentielLabel="Présentiel Nantes" />
          </div>
        </div>
      </div>
    </section>
...
const raisons = [
  ...
  {
    n: '02',
    title: 'Présentiel à Nantes ET distanciel structuré',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Pour les phases stratégiques (cadrage, ateliers, COMEX), nous nous déplaçons régulièrement à Nantes (Île de Nantes, Quartier de la Création, centre-ville, Erdre, Bouffay), à Saint-Herblain (industrie, services aux entreprises), à Rezé, et plus largement en Pays de la Loire (Angers, La Roche-sur-Yon sur demande). Pour la phase de build, <strong style={{ color: '#09090b' }}>mode distanciel structuré</strong> avec points hebdomadaires de 30 minutes. Vous choisissez la modalité.
      </p>
    ),
  },
  {
    ...
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        <a href="/services/formation-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Ateliers de formation IA</a> en présentiel dans vos locaux à Nantes ou en distanciel synchrone. Formats <strong style={{ color: '#09090b' }}>4h à 21h</strong>, adaptés par métier. Particulièrement utiles pour les équipes des agences digitales, scale-up tech de l'Île de Nantes et laboratoires biotech Atlanpole.
      </p>
    ),
  },
  {
    ...
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Mistral hébergé France, infrastructure auto-hébergeable, aucune donnée envoyée à OpenAI ou Anthropic sans accord client. <strong style={{ color: '#09090b' }}>Critère essentiel pour le tissu nantais</strong> : numérique et scale-up (Île de Nantes), biotech ouest (Atlanpole biothérapies, CHU Nantes recherche clinique), agroalimentaire régional (Lactalis, Sodebo, Charal), industrie navale (sous-traitance Chantiers de l'Atlantique). Voir <a href="/#souverainete" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Souveraineté</a>.
      </p>
    ),
  },
  {
    ...
    <section id="pourquoi" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        <div style={{ marginBottom: 52, opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s ease' }}>
          <H2 style={{ marginBottom: 16 }}>Pourquoi travailler avec Althoce pour votre projet IA à Nantes</H2>
          <p style={{ fontSize: 16, color: '#52525b', lineHeight: 1.7, maxWidth: 640 }}>
            Cinq raisons concrètes qui nous distinguent des autres prestataires IA en Pays de la Loire.
          </p>
        </div>
        ...
        <div style={{ marginTop: 48, borderRadius: 20, background: '#09090b', border: '1px solid #1e1e1e', overflow: 'hidden', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s .5s ease' }}>
          ...
          <div style={{ padding: '24px 28px' }}>
            <p style={{ fontSize: 16, color: '#a1a1aa', lineHeight: 1.8, margin: '0 0 16px' }}>
              <strong style={{ color: '#e4e4e7' }}>Mêmes délais, même qualité quel que soit le mode.</strong> Présentiel pertinent pour le cadrage et les ateliers à Nantes (Île de Nantes, Quartier de la Création). Distanciel pour le build (60 à 70 % du projet) gagne du temps à tout le monde.
            </p>
...
function MetierMockup({ index }: { index: number }) {
  const mockups = [
    // Marketing content scale-up
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 10 }}>SaaS B2B · Île de Nantes</div>
      {[{ l: 'Content produit / 6 mois', v: '×4' }, { l: 'Trafic organique', v: '+140 %' }, { l: 'Articles SEO / mois', v: '1 → 4' }, { l: 'Budget annulé', v: '60 k€/an' }].map((r, i) => (
    ...
    <div style={{ background: '#09090b', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.18)', border: `1px solid ${AC}30` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        <span style={{ fontSize: 12, fontWeight: 800, color: '#3f3f46', textTransform: 'uppercase', letterSpacing: '.1em' }}>SaaS B2B · Nantes</span>
    ...
    // Finance cabinets / biotech
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 10 }}>Cabinet comptable · Nantes</div>
    ...
    // RH recrutement tech
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>Cabinet recrutement · Nantes</div>
      {[{ l: 'Volume CV triés', v: '×3,5' }, { l: 'Temps RH libéré', v: '60 %' }, { l: 'Conformité RGPD', v: 'Opposable' }, { l: 'Biais documentés', v: '0' }].map((r, i) => (
...
const metiers = [
  {
    n: '01', href: '/agent-ia/marketing/', label: 'Marketing et content (agences digitales, scale-up tech)', tag: 'Agent IA Marketing →',
    desc: "Les agences digitales nantaises (forte densité Île de Nantes, Quartier de la Création) et les scale-up tech régionales doivent produire du contenu multi-canal au ton de marque. Notre agent IA marketing produit articles SEO, posts LinkedIn, newsletters segmentées sans dégradation qualitative. Cas type : éditeur SaaS B2B nantais, content ×4 en 6 mois, trafic organique +140 %.",
    pub: "Agences digitales Île de Nantes · Scale-up tech Quartier de la Création · Éditeurs SaaS B2B · Start-up numérique Pays de la Loire",
    reverse: false,
  },
  {
    n: '02', href: '/agent-ia/service-client/', label: 'Service client (SaaS, e-commerce nantais)', tag: 'Agent IA Service client →',
    desc: "Les éditeurs SaaS nantais (scale-up tech, plateformes B2B Île de Nantes) et les e-commerces régionaux croulent sous les tickets répétitifs. Notre agent IA absorbe 70 % du N1 en autonomie. Cas type : éditeur SaaS B2B 8 000 clients PME, CSAT +12 points en 3 mois.",
    pub: "Éditeurs SaaS B2B Île de Nantes · Plateformes tech · E-commerce régional · Scale-up Pays de la Loire",
    reverse: true,
  },
  {
    n: '03', href: '/agent-ia/finance/', label: 'Finance et comptabilité (cabinets nantais, biotech)', tag: 'Agent IA Finance →',
    desc: "Les cabinets d'expertise comptable nantais (forte densité centre-ville, Erdre, Bouffay) et les directions financières des biotech et scale-up de l'Île de Nantes absorbent 60 à 80 % de saisie répétitive (factures fournisseurs, rapprochement bancaire, écritures). Cas signature : cabinet d'expertise comptable, ×2 capacité en 4 mois, souveraineté Mistral France.",
    pub: "Cabinets comptable Bouffay / Erdre · Directions financières biotech · CFO scale-up · Comptabilité agroalimentaire Pays de la Loire",
    reverse: false,
  },
  {
    n: '04', href: '/agent-ia/rh/', label: 'RH et recrutement (tech, biotech)', tag: 'Agent IA RH →',
    desc: "Le tissu tech et biotech nantais consomme énormément de talents (développeurs, profils tech, chercheurs biotech Atlanpole). Les cabinets de recrutement spécialisés et les DRH des scale-up de l'Île de Nantes trient des volumes de CV importants. Notre agent IA tri CV anti-biais documenté absorbe la pré-qualification. Cas type : ×3,5 volume CV triés, conformité RGPD opposable.",
    pub: "Cabinets recrutement tech Nantes · DRH scale-up Île de Nantes · RH biotech Atlanpole · Recrutement numérique Pays de la Loire",
    reverse: true,
  },
];

function MetiersNantes() {
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto' }}>
        <div style={{ marginBottom: 56 }}>
          <H2 style={{ marginBottom: 12 }}>L'IA transforme chaque métier nantais</H2>
          <p style={{ fontSize: 16, color: '#52525b', maxWidth: 640, lineHeight: 1.7 }}>
            Quatre métiers où nos agents IA ont déjà transformé le quotidien de PME et ETI nantaises, des scale-up de l'Île de Nantes aux laboratoires biotech d'Atlanpole. Pour la liste complète, voir notre <a href="/agent-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>hub agents IA par fonction</a>.
          </p>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 56 }}>
          {metiers.map((m, i) => (
            <div key={i} className={`nan-metier-row${m.reverse ? ' nan-metier-rev' : ''}`}
              ...
              <div style={{ order: m.reverse ? 2 : 1 }}>
                ...
                <div style={{ padding: '10px 16px', borderRadius: 10, background: '#f0f7ff', border: `1px solid ${AC}15`, marginBottom: 20 }}>
                  <div style={{ fontSize: 10, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 4 }}>Public type Nantes / Pays de la Loire</div>
              ...
              <div className="nan-mockup-col" style={{ order: m.reverse ? 1 : 2 }}>
        ...
        <div style={{ marginTop: 64, overflow: 'hidden', borderTop: '1px solid #e4e4e7', paddingTop: 32 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', gap: 10, animation: 'nan-ticker 60s linear infinite', width: 'max-content' }}>
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .6s ease' }}>
        <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.14em', marginBottom: 24 }}>Cas client nantais · Anonymisé</div>
        <H2 style={{ marginBottom: 20 }}>Éditeur SaaS B2B Île de Nantes : marketing content multiplié par 4 en 6 mois</H2>

        <div style={{ display: 'inline-flex', flexWrap: 'wrap', gap: 6, marginBottom: 40, padding: '6px 14px', borderRadius: 9999, background: '#f4f4f5' }}>
          {['Éditeur SaaS B2B', '90 collaborateurs', 'Île de Nantes', '2025-2026', 'cas anonymisé'].map((t) => (
        ...
        <div className="nan-cas-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.8fr', gap: 48, alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { v: '×4', l: 'volume content en 6 mois sans embauche', hero: true },
              { v: '+140 %', l: 'trafic organique en 6 mois', hero: false },
              { v: '1 → 4', l: 'articles SEO par mois', hero: false },
              { v: '60 k€/an', l: 'budget content manager annulé', hero: false },
            ].map((k, i) => (
              <div key={i} style={{ borderRadius: 14, background: k.hero ? '#09090b' : '#f8faff', border: k.hero ? `1px solid ${AC}40` : `1px solid ${AC}15`, padding: '18px 22px', display: 'flex', alignItems: 'center', gap: 14 }}>
                <div style={{ fontSize: k.hero ? 28 : 24, fontWeight: 900, color: AC, letterSpacing: '-.04em', lineHeight: 1, flexShrink: 0 }}>{k.v}</div>
          ...
          <div>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, marginBottom: 20 }}>
              L'éditeur SaaS nantais avait une ambition content marketing 4× supérieure à sa capacité humaine (équipe 3 personnes). <strong style={{ color: '#09090b' }}>La direction commerciale demandait du contenu chaque semaine, l'équipe était à bout.</strong> Un recrutement content manager senior à 60 k€ chargés avait été évalué.
            </p>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, marginBottom: 28 }}>
              Agent IA marketing Althoce déployé en <strong style={{ color: '#09090b' }}>3 semaines</strong>, avec cadrage strict du ton de marque (indexation de 180 articles existants comme référence). Aujourd'hui, la responsable marketing consacre 30 à 50 % de son temps à la stratégie de positionnement, reportée depuis 2 ans. Trafic organique +140 % en 6 mois.
            </p>
            <div style={{ padding: '20px 24px', borderRadius: 16, background: '#fafafa', border: '1px solid #e4e4e7', borderLeft: `4px solid ${AC}`, marginBottom: 28 }}>
              ...
              <blockquote style={{ fontSize: 16, fontWeight: 700, color: '#09090b', lineHeight: 1.65, margin: '0 0 10px', fontStyle: 'normal' }}>
                J'avais un backlog de sujets content depuis 18 mois et une équipe saturée. En 3 semaines, Althoce a calé le ton de marque sur 180 articles existants. Maintenant je pilote la stratégie, l'agent exécute. Notre trafic organique a doublé.
              </blockquote>
              <div style={{ fontSize: 13, color: '#8a8a95', fontWeight: 600 }}>Responsable marketing · Éditeur SaaS B2B · Île de Nantes · 2026</div>
            </div>
            <a href="/cas-clients/saas-b2b-agent-ia-marketing/" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 700, color: AC, textDecoration: 'none', transition: 'gap .15s' }}
  ...
  return (
    <section id="method" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div className="nan-grid4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24 }}>
          {steps.map((s, i) => (
...
// ── FAQ locale Nantes ─────────────────────────────────────────
const faqNantes = [
  { q: "Présentiel à Nantes ou distanciel : différence ?", a: "Aucune sur qualité et délais. Présentiel pertinent à Nantes (Île de Nantes, Quartier de la Création, centre-ville, Bouffay), Saint-Herblain, ou ailleurs en Pays de la Loire pour le cadrage et les ateliers. Build en distanciel structuré avec points hebdomadaires de 30 minutes. Vous choisissez la modalité selon le projet." },
  { q: "Avez-vous un bureau permanent à Nantes ?", a: "Pas de bureau permanent. Espaces partenaires sur l'Île de Nantes pour les RDV présentiels. Déplacements réguliers dans la métropole et en Pays de la Loire." },
  { q: "Proposez-vous des formations IA pour mes équipes nantaises ?", a: "Oui. Nos ateliers de formation IA sont dispensés en présentiel dans vos locaux (Nantes, Pays de la Loire) ou en distanciel synchrone. Formats 4h à 21h selon objectifs. Particulièrement utiles pour les équipes des agences digitales, scale-up tech et laboratoires biotech Atlanpole." },
  { q: "Avez-vous une expertise spécifique sur la biotech ouest (Atlanpole, CHU Nantes) ?", a: "Oui. Conformité réglementaire (HAS, ANSM), souveraineté Mistral hébergé France obligatoire pour les données de recherche clinique. Cas types : agents IA gestion documentaire pharma, veille réglementaire continue, vigilance fournisseurs critiques. Données patients restent sur infrastructure France." },
  { q: "Mes données restent-elles en France ?", a: "Oui par défaut. Mistral hébergé France (OVH, Scaleway). Particulièrement strict pour biotech (données patients, secret recherche), agroalimentaire premium (Pays de la Loire) et sous-traitance navale Saint-Nazaire." },
  { q: "Avez-vous des clients en Pays de la Loire ?", a: "Oui. Scale-up tech Île de Nantes, biotech Atlanpole, cabinets d'expertise comptable centre-ville, agences digitales Quartier de la Création. Notre cas signature marketing est directement transposable au tissu régional nantais : SaaS, agences, numérique." },
];
    ...
    <section id="faq" style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 52 }}>
          <H2 style={{ marginBottom: 12 }}>Questions fréquentes : Althoce à Nantes et en Pays de la Loire</H2>
          <p style={{ fontSize: 16, color: '#52525b' }}>Réponses directes aux questions que posent nos prospects nantais avant la prise de contact.</p>
        </div>
        <FAQAccordion items={faqNantes} />
      </div>
    </section>
  );
}
...
function Souverainete() {
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#09090b', borderTop: '1px solid #1a1a1a' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        <div className="nan-split-rev" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'center' }}>
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .7s ease' }}>
        ...
        <H2 style={{ marginBottom: 20 }}>
          Prêt à déployer votre premier agent IA<br /><span style={{ color: AC }}>à Nantes ou en Pays de la Loire ?</span>
        </H2>
        <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 40, maxWidth: 520, margin: '0 auto 40px' }}>
          Un échange de 30 minutes suffit à identifier le cas d'usage le plus impactant. Repartez avec une feuille de route et un devis ferme sous 5 jours. Présentiel à Nantes ou distanciel, que l'on travaille ensemble ou non.
        </p>
...
// ── CSS ───────────────────────────────────────────────────────
const globalStyles = `
  @keyframes nan-drift { 0%,100%{transform:translate(0,0) scale(1)}50%{transform:translate(3%,4%) scale(1.06)} }
  @keyframes floatCard { 0%,100%{transform:translateY(0)}50%{transform:translateY(-6px)} }
  @keyframes nan-ticker { from{transform:translateX(0)}to{transform:translateX(-50%)} }

  @media (max-width:860px) {
    .nan-hero-grid { grid-template-columns:1fr !important; }
    .nan-map-col { display:none !important; }
    .nan-split-rev { grid-template-columns:1fr !important; }
    .nan-cas-grid { grid-template-columns:1fr !important; }
    .nan-metier-row { grid-template-columns:1fr !important; }
    .nan-metier-rev > div { order:unset !important; }
    .nan-mockup-col { display:none !important; }
    .nan-grid4 { grid-template-columns:repeat(2,1fr) !important; }
  }
  @media (max-width:560px) {
    .nan-grid4 { grid-template-columns:1fr !important; }
  }
`;

export default function AgenceIANantesPageClient() {
  return (
    <main>
