...
const faqAudit: FAQv2Item[] = [
  { q: "Quelle est la différence entre les 30 minutes offertes avec un expert et l'audit IA Althoce ?", a: "Les 30 minutes offertes qualifient un besoin précis : faut-il déployer un agent IA, un chatbot RAG, ou cadrer un projet plus large ? C'est gratuit et sans engagement. L'audit IA est une prestation à part entière : il cartographie toutes les opportunités d'automatisation, chiffre le retour projet par projet et produit 6 livrables. Il s'adresse aux structures qui veulent une vue d'ensemble avant de lancer plusieurs chantiers." },
