  ...
  return (
    <section style={{ padding: '120px 24px 80px', position: 'relative', overflow: 'hidden', borderBottom: '1px solid #e4e4e7' }}>
      <div aria-hidden="true" style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
        <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: 600, height: 600, borderRadius: '50%', background: `radial-gradient(circle,${AC}0a 0%,transparent 65%)`, filter: 'blur(80px)', animation: 'rei-drift 14s ease-in-out infinite' }} />
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1160, margin: '0 auto' }}>
        <div className="rei-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            <nav aria-label="Breadcrumb" style={{ fontSize: 13, color: '#a1a1aa', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', fontWeight: 500 }}>
              ...
              <span style={{ color: '#09090b' }}>Reims</span>
            </nav>

            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 24 }}>
              {['+150 PME équipées en France', 'Expertise champagne et export multilingue', 'Présentiel + distanciel'].map((t) => (
            ...
            <h1 style={{ fontSize: 'clamp(26px,3.8vw,50px)', fontWeight: 800, lineHeight: 1.08, letterSpacing: '-.04em', color: '#09090b', marginBottom: 20 }}>
              Agence IA à Reims : agents IA, automatisation et formation pour PME et ETI rémoises.
            </h1>

            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 32, maxWidth: 520 }}>
              Vous dirigez une PME ou une ETI à Reims, dans la Marne ou en Champagne-Ardenne. Althoce vous accompagne avec une expertise sur les secteurs forts régionaux (maisons de champagne, agroalimentaire premium, pharma, distribution premium) et une approche hybride présentiel-distanciel.
            </p>
          ...
          <div className="rei-map-col" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <FranceMapSVG mainCity="Reims" presentielLabel="Présentiel Reims" />
          </div>
        </div>
      </div>
    </section>
...
const raisons = [
  ...
  {
    n: '02',
    title: 'Présentiel à Reims ET distanciel structuré',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Déplacements à Reims (centre-ville, Henri Farman), Saint-Brice-Courcelles (technopôle), Tinqueux, Cormontreuil, et plus largement dans la Marne et Champagne-Ardenne (Épernay côté maisons de champagne, Châlons-en-Champagne). Pour la phase de build, <strong style={{ color: '#09090b' }}>mode distanciel structuré</strong> avec points hebdomadaires de 30 minutes. Vous choisissez la modalité.
      </p>
    ),
  },
  {
    n: '03',
    title: 'Formation IA pour vos équipes rémoises',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        <a href="/services/formation-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Ateliers de formation IA</a> en présentiel à Reims ou en distanciel synchrone. Formats <strong style={{ color: '#09090b' }}>4h à 21h</strong>, adaptés par métier. Particulièrement utiles pour les équipes export champagne (multilingue obligatoire), agroalimentaire premium (conformité IFS/BRC) et pharma.
      </p>
    ),
  },
  {
    ...
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Mistral hébergé France, infrastructure auto-hébergeable, aucune donnée envoyée à OpenAI ou Anthropic sans accord client. <strong style={{ color: '#09090b' }}>Critique pour le tissu rémois</strong> : maisons de champagne premium (secret commercial, recettes, allocations primeurs confidentielles), agroalimentaire premium (normes sanitaires européennes), pharma régionale. Voir <a href="/#souverainete" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Souveraineté</a>.
      </p>
    ),
  },
  {
    ...
    <section id="pourquoi" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        <div style={{ marginBottom: 52, opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s ease' }}>
          <H2 style={{ marginBottom: 16 }}>Pourquoi travailler avec Althoce pour votre projet IA à Reims</H2>
          <p style={{ fontSize: 16, color: '#52525b', lineHeight: 1.7, maxWidth: 640 }}>
            Cinq raisons concrètes qui nous distinguent des autres prestataires IA en Champagne-Ardenne.
          </p>
        </div>
        ...
        <div style={{ marginTop: 48, borderRadius: 20, background: '#09090b', border: '1px solid #1e1e1e', overflow: 'hidden', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s .5s ease' }}>
          ...
          <div style={{ padding: '24px 28px' }}>
            <p style={{ fontSize: 16, color: '#a1a1aa', lineHeight: 1.8, margin: '0 0 16px' }}>
              <strong style={{ color: '#e4e4e7' }}>Mêmes délais, même qualité quel que soit le mode.</strong> Présentiel pertinent pour le cadrage à Reims (Henri Farman, centre-ville) ou à Épernay côté maisons de champagne. Distanciel pour le build (60 à 70 % du projet) gagne du temps à tout le monde.
            </p>
...
function MetierMockup({ index }: { index: number }) {
  const mockups = [
    // Commercial export — SDR multilingue champagne
    <div style={{ background: '#09090b', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.18)', border: `1px solid ${AC}30` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        <span style={{ fontSize: 12, fontWeight: 800, color: '#3f3f46', textTransform: 'uppercase', letterSpacing: '.1em' }}>Maison de champagne · Reims</span>
      ...
      {[{ l: 'RDV importateurs qualifiés', v: '+200 %' }, { l: 'Langues gérées', v: '4 (FR/EN/ZH/JA)' }, { l: 'Nouveaux comptes asiatiques', v: '4 grands' }, { l: 'ROI constaté', v: '6 mois' }].map((r, i) => (
    ...
    // Marketing — content premium maisons de champagne
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>Agence communication · Reims</div>
      {[{ l: 'Contenus premium / mois', v: '×4' }, { l: 'Cohérence brand', v: '100 %' }, { l: 'Budget rédactionnel annulé', v: '48 k€/an' }, { l: 'Délai 1er contenu', v: '3 semaines' }].map((r, i) => (
    ...
    // Achats — matières premières premium packaging champagne
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>ETI agroalimentaire · Marne</div>
    ...
    // Service client — export multilingue distribution premium
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 10 }}>Distributeur premium · Champagne</div>
      {[{ l: 'N1 absorbé en autonomie', v: '70 %' }, { l: 'Langues B2B gérées', v: '9 langues' }, { l: 'CSAT', v: '+12 pts' }, { l: 'Souveraineté Mistral', v: '100 % FR' }].map((r, i) => (
        <div key={i} style={{ marginBottom: 10 }}>
          ...
          <div style={{ height: 4, background: '#f4f4f5', borderRadius: 9999, overflow: 'hidden' }}>
            <div style={{ height: '100%', width: `${[70, 90, 85, 100][i]}%`, background: `linear-gradient(to right,${AC},${AC}88)`, borderRadius: 9999 }} />
          </div>
        </div>
      ))}
    </div>,
...
const metiers = [
  {
    n: '01', href: '/agent-ia/commercial/', label: 'Commercial export (champagne, agroalimentaire premium)', tag: 'Agent IA Commercial →',
    desc: "Les maisons de champagne rémoises et épernayennes (LVMH Moët, Veuve Clicquot, Pommery, Taittinger, maisons familiales) et les acteurs agroalimentaires premium ont une activité export majoritaire (60 à 90 % du CA) avec qualification de prospects internationaux multilingues. Notre agent IA SDR multilingue prospecte 24/7 sur LinkedIn et email, qualifie les importateurs et cavistes haut de gamme. Cas signature : négoce bordelais, +200 % RDV qualifiés en 4 mois en 4 langues.",
    pub: "Maisons de champagne Reims et Épernay · Négociants export Champagne · Agroalimentaire premium Marne · Distribution luxe internationale",
    reverse: false,
  },
  {
    n: '02', href: '/agent-ia/marketing/', label: 'Marketing et content (maisons de champagne, agences luxe)', tag: 'Agent IA Marketing →',
    desc: "Les équipes marketing des maisons de champagne et les agences de communication rémoises doivent produire un contenu premium au ton de marque sans concession qualitative (storytelling terroir, héritage familial, viticulture durable). Notre agent IA marketing produit articles, newsletters, social media en cohérence brand. Cas type : éditeur SaaS B2B, content ×4 sans embauche, trafic +140 %.",
    pub: "Maisons de champagne Reims · Agences communication luxe · Acteurs agroalimentaire premium · Domaines viticoles Champagne",
    reverse: true,
  },
  {
    n: '03', href: '/agent-ia/achats/', label: 'Achats (sourcing matières premières, packaging premium)', tag: 'Agent IA Achats →',
    desc: "Les directions achats des maisons de champagne (verre, bouchons, étiquettes, packaging premium, services logistiques export) et des acteurs agroalimentaires premium gèrent des panels fournisseurs spécialisés avec exigences fortes (qualité, traçabilité, conformité européenne, souveraineté). Notre agent IA combine sourcing accéléré et vigilance financière fournisseurs continue. Cas signature : ETI industrielle, +4 % d'économies = 1,2 M€.",
    pub: "Maisons de champagne (verre, packaging) · Agroalimentaire Marne · Fournisseurs premium IFS/BRC · ETI industrielles Champagne-Ardenne",
    reverse: false,
  },
  {
    n: '04', href: '/agent-ia/service-client/', label: 'Service client export multilingue (champagne, distribution premium)', tag: 'Agent IA Service client →',
    desc: "Les maisons de champagne et les distributeurs premium gèrent une clientèle internationale exigeante (importateurs, cavistes haut de gamme, sommeliers, hôtellerie luxe). Notre chatbot IA RAG multilingue absorbe les demandes B2B en 9 langues et escalade automatiquement pour les demandes complexes. Cas type : éditeur SaaS B2B 8 000 clients, CSAT +12 points en 3 mois.",
    pub: "Maisons de champagne export · Distributeurs premium Reims · Hôtellerie luxe Champagne · Importateurs cavistes internationaux",
    reverse: true,
  },
];

function MetiersReims() {
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto' }}>
        <div style={{ marginBottom: 56 }}>
          <H2 style={{ marginBottom: 12 }}>L'IA transforme chaque métier rémois</H2>
          <p style={{ fontSize: 16, color: '#52525b', maxWidth: 640, lineHeight: 1.7 }}>
            Quatre métiers où nos agents IA ont déjà transformé le quotidien de PME, ETI rémoises et de maisons de champagne. Pour la liste complète, voir notre <a href="/agent-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>hub agents IA par fonction</a>.
          </p>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 56 }}>
          {metiers.map((m, i) => (
            <div key={i} className={`rei-metier-row${m.reverse ? ' rei-metier-rev' : ''}`}
              ...
              <div style={{ order: m.reverse ? 2 : 1 }}>
                ...
                <div style={{ padding: '10px 16px', borderRadius: 10, background: '#f0f7ff', border: `1px solid ${AC}15`, marginBottom: 20 }}>
                  <div style={{ fontSize: 10, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 4 }}>Public type Reims / Champagne-Ardenne</div>
              ...
              <div className="rei-mockup-col" style={{ order: m.reverse ? 1 : 2 }}>
        ...
        <div style={{ marginTop: 64, overflow: 'hidden', borderTop: '1px solid #e4e4e7', paddingTop: 32 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', gap: 10, animation: 'rei-ticker 60s linear infinite', width: 'max-content' }}>
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .6s ease' }}>
        <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.14em', marginBottom: 24 }}>Cas client Champagne · Anonymisé</div>
        <H2 style={{ marginBottom: 20 }}>Maison de champagne rémoise : agent IA SDR multilingue pour ouvrir les marchés asiatiques</H2>

        <div style={{ display: 'inline-flex', flexWrap: 'wrap', gap: 6, marginBottom: 40, padding: '6px 14px', borderRadius: 9999, background: '#f4f4f5' }}>
          {['Maison de champagne familiale', '50 collaborateurs', 'Reims', '2025-2026', 'cas anonymisé'].map((t) => (
        ...
        <div className="rei-cas-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.8fr', gap: 48, alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { v: '+180 %', l: 'RDV qualifiés importateurs asiatiques', hero: true },
              { v: '4 langues', l: 'prospection 24/7 (FR/EN/ZH/JA)', hero: false },
              { v: '4', l: 'nouveaux comptes grands importateurs', hero: false },
              { v: '6 mois', l: "ouverture marché Japon et Chine", hero: false },
            ].map((kpi, i) => (
          ...
          <div>
            <h3 style={{ fontSize: 18, fontWeight: 800, color: '#09090b', marginBottom: 16, lineHeight: 1.3 }}>Ambition Asie depuis 3 ans, bloquée faute de commercial trilingue mandarin-japonais disponible à Reims.</h3>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 20 }}>
              La maison de champagne rémoise (volume principal France + Europe, ambition d'ouvrir l'Asie depuis 3 ans) ne disposait pas de commercial trilingue pour développer le marché asiatique. Recruter un commercial mandarin et japonais à Reims s'était révélé impossible à budget raisonnable. La directrice export gérait manuellement quelques contacts via LinkedIn, sans méthode ni volume suffisant.
            </p>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 28 }}>
              Agent IA SDR multilingue Althoce déployé en 6 semaines (cadrage présentiel à Reims, build distanciel). L'agent prospecte aujourd'hui 24/7 sur LinkedIn et email les importateurs et cavistes haut de gamme asiatiques en français, anglais, mandarin et japonais. En 6 mois, la directrice export a ouvert 4 nouveaux comptes grands importateurs — dont 2 au Japon et 2 en Chine continentale.
            </p>
            ...
            <div style={{ padding: '20px 24px', borderRadius: 14, background: '#f0f7ff', border: `1px solid ${AC}20`, marginBottom: 24 }}>
              <p style={{ fontSize: 15, color: '#1e3a5f', lineHeight: 1.75, margin: 0, fontStyle: 'italic' }}>
                "On avait essayé d'aller en Asie depuis 3 ans. En 6 mois avec l'agent IA, on a signé 4 comptes importateurs qu'on n'aurait jamais pu atteindre seuls. Le japonais et le mandarin ont tout changé."
              </p>
              <div style={{ marginTop: 10, fontSize: 13, fontWeight: 700, color: '#52525b' }}>Directrice export · Maison de champagne familiale rémoise</div>
            </div>

            <a href="/cas-clients/negoce-vins-bordelais-agent-ia-sdr/" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 700, color: AC, textDecoration: 'none', padding: '10px 20px', border: `1px solid ${AC}30`, borderRadius: 9999, transition: 'all .15s' }}
              onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.background = `${AC}08`; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.background = 'transparent'; }}>
              Lire le cas signature commercial export →
            </a>
          </div>
        </div>
      </div>
  ...
  return (
    <section id="method" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div className="rei-grid4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24 }}>
          {steps.map((s, i) => (
...
const faqReims = [
  {
    q: "Présentiel à Reims ou distanciel : quelle différence ?",
    a: "Aucune différence qualité ni délais. Présentiel pertinent à Reims (centre-ville, Henri Farman), Épernay côté maisons de champagne, et plus largement dans la Marne pour le cadrage et les ateliers. Build en distanciel structuré avec points hebdomadaires de 30 minutes.",
  },
  {
    q: "Avez-vous un bureau permanent à Reims ?",
    a: "Pas de bureau permanent. Déplacements réguliers, espaces partenaires centre-ville Reims pour les RDV présentiels. Déplacements réguliers dans la Marne et Champagne-Ardenne (Épernay, Châlons-en-Champagne sur demande).",
  },
  {
    q: "Proposez-vous des formations IA pour mes équipes rémoises ?",
    a: "Oui. Ateliers de formation IA en présentiel à Reims ou en distanciel synchrone. Formats 4h à 21h, adaptés par métier. Particulièrement utiles pour les équipes export champagne (multilingue obligatoire), agroalimentaire premium (conformité IFS/BRC) et pharma.",
  },
  {
    q: "Avez-vous une expertise sur les maisons de champagne et l'export multilingue ?",
    a: "Oui. Cas types : agent IA SDR multilingue (FR, EN, mandarin, japonais, allemand, italien), chatbot RAG multilingue pour relations B2B internationales (importateurs, cavistes, sommeliers), automatisation ADV export. Données hébergées Mistral France, secret commercial garanti.",
  },
  {
    q: "Mes données restent-elles en France ?",
    a: "Oui par défaut. Mistral hébergé France (OVH, Scaleway). Critique pour les maisons de champagne (secret commercial : allocations primeurs, conditions importateurs, marges fournisseurs), l'agroalimentaire premium (normes sanitaires européennes) et la pharma régionale.",
  },
  {
    q: "Avez-vous des clients à Reims et en Champagne ?",
    a: "Oui. Maisons de champagne familiales, agroalimentaire premium régional, cabinets d'expertise comptable rémois. Notre cas signature commercial export (agent SDR multilingue, +180 % RDV asiatiques, 4 nouveaux comptes en 6 mois) est directement transposable au tissu des maisons de champagne rémoises.",
  },
];
    ...
    <section id="faq" style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 52 }}>
          <H2 style={{ marginBottom: 12 }}>Questions fréquentes : Althoce à Reims et en Champagne-Ardenne</H2>
          <p style={{ fontSize: 16, color: '#52525b' }}>Réponses directes aux questions que posent nos prospects rémois avant la prise de contact.</p>
        </div>
        <FAQAccordion items={faqReims} />
      </div>
    </section>
  );
}
...
function Souverainete() {
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#09090b', borderTop: '1px solid #1a1a1a' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        <div className="rei-split-rev" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'center' }}>
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .7s ease' }}>
        ...
        <H2 style={{ marginBottom: 20 }}>
          Prêt à déployer votre premier agent IA<br /><span style={{ color: AC }}>à Reims ou en Champagne-Ardenne ?</span>
        </H2>
        <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 40, maxWidth: 520, margin: '0 auto 40px' }}>
          Un échange de 30 minutes suffit à identifier le cas d'usage le plus impactant. Repartez avec une feuille de route et un devis ferme sous 5 jours. Présentiel à Reims ou en Marne, ou distanciel, que l'on travaille ensemble ou non.
        </p>
...
// ── CSS ───────────────────────────────────────────────────────
const globalStyles = `
  @keyframes rei-drift { 0%,100%{transform:translate(0,0) scale(1)}50%{transform:translate(3%,4%) scale(1.06)} }
  @keyframes rei-ticker { from{transform:translateX(0)}to{transform:translateX(-50%)} }
  ...
  @media (max-width:860px) {
    .rei-hero-grid { grid-template-columns:1fr !important; }
    .rei-map-col { display:none !important; }
    .rei-split-rev { grid-template-columns:1fr !important; }
    .rei-cas-grid { grid-template-columns:1fr !important; }
    .rei-metier-row { grid-template-columns:1fr !important; }
    .rei-metier-rev > div { order:unset !important; }
    .rei-mockup-col { display:none !important; }
    .rei-grid4 { grid-template-columns:repeat(2,1fr) !important; }
  }
  @media (max-width:560px) {
    .rei-grid4 { grid-template-columns:1fr !important; }
  }
`;

export default function AgenceIAReimsPageClient() {
  return (
    <main>
