        ...
        <div className="cpt-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            <nav aria-label="Breadcrumb" style={{ fontSize: 13, color: '#a1a1aa', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', fontWeight: 500 }}>
              ...
              <span>›</span>
              <span style={{ color: '#09090b' }}>Agent IA comptabilité</span>
            </nav>
...
const avantItems = [
  ...
  { time: '18h30', text: 'Départ, frustrée. Reporting mensuel toujours inachevé. La file d\'attente n\'a pas bougé.' },
];
...
const apresItems = [
  ...
  { time: '8h45', text: 'Tout est passé dans Sage. Rapprochement bancaire automatique : 1 seul cas litigieux à traiter.' },
  ...
  { time: '17h30', text: 'Départ sereine. Le plan analytique est avancé. L\'agent continue 24/7 pour la nuit suivante.' },
];
  ...
  return (
    <section ref={ref} id="agents" style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 56 }}>
          <H2 style={{ marginBottom: 12 }}>4 agents IA déjà déployés en comptabilité chez nos clients.</H2>
          <p style={{ fontSize: 16, color: '#52525b', maxWidth: 560, margin: '0 auto' }}>
            Sur les 30 agents du catalogue Althoce, 4 sont spécifiquement conçus pour la comptabilité PME. Chacun adresse un segment précis du flux documentaire.
          </p>
        </div>
        ...
        <div style={{ marginTop: 24, padding: '20px 24px', borderRadius: 16, background: `${AC}06`, border: `1px solid ${AC}20`, fontSize: 15, color: '#52525b', lineHeight: 1.7 }}>
          ...
          pour une automatisation plus large (RH, commercial, operations). Les 30 minutes offertes avec un expert permettent de cadrer la combinaison optimale pour votre contexte comptable.
        </div>
      </div>
    </section>
  );
...
const faqComptabilite: FAQv2Item[] = [
  ...
  },
  {
    ...
    a: 'L\'agent prépare un brouillon (pré-remplissage à partir des écritures), votre expert ou DAF valide, signe, télétransmet. Nous ne signons jamais une déclaration à la place de l\'humain — ce n\'est ni légal ni souhaitable. En revanche, le pré-remplissage automatique fait économiser 50 à 70 % du temps de préparation.',
  },
  {
...
const globalStyles = `
  ...
  .ticker-slow { display:flex;animation:tickerSlide 30s linear infinite;width:max-content; }
  ...
  @media (max-width: 640px) {
    ...
    .cpt-kpi-grid { grid-template-columns: 1fr !important; }
    .cpt-kpi-grid > div:nth-last-child(2) { border-bottom: 1px solid #1a1a1a !important; }
    .v2-grid4 { grid-template-columns: 1fr !important; }
  }
`;

// ── Page ──────────────────────────────────────────────────────
export default function AgentIAComptabilitePageClient() {
  return (
    <main>
