  ...
  const pillarData = [
    {
      ...
      desc: 'Un agent IA Althoce absorbe une tâche répétitive précise dans votre quotidien : qualification de leads, traitement de factures, classification de mails, génération de rapports. Un cas d\'usage borné, une semaine de delivery. Le format d\'entrée le plus utilisé chez nos clients PME en 2026.',
...
const satelliteServices = [
  ...
  },
  {
    ...
    desc: 'Pas un chatbot scripté. Un chatbot RAG ancré sur votre base de connaissances (FAQ, docs, intranet). Cite ses sources, escalade quand il ne sait pas.',
    badge: "Format d'entrée",
  },
  {
    n: '03',
