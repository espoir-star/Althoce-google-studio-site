  ...
  return (
    <section style={{ padding: '120px 24px 80px', position: 'relative', overflow: 'hidden', borderBottom: '1px solid #e4e4e7' }}>
      <div aria-hidden="true" style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
        <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: 600, height: 600, borderRadius: '50%', background: `radial-gradient(circle,${AC}0a 0%,transparent 65%)`, filter: 'blur(80px)', animation: 'tln-drift 14s ease-in-out infinite' }} />
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1160, margin: '0 auto' }}>
        <div className="tln-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            <nav aria-label="Breadcrumb" style={{ fontSize: 13, color: '#a1a1aa', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', fontWeight: 500 }}>
              ...
              <span style={{ color: '#09090b' }}>Toulon</span>
            </nav>

            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 24 }}>
              {['+150 PME équipées en France', 'Souveraineté France garantie', 'Présentiel + distanciel'].map((t) => (
            ...
            <h1 style={{ fontSize: 'clamp(26px,3.8vw,50px)', fontWeight: 800, lineHeight: 1.08, letterSpacing: '-.04em', color: '#09090b', marginBottom: 20 }}>
              Agence IA à Toulon : agents IA, automatisation et formation pour PME et ETI varoises.
            </h1>

            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 32, maxWidth: 520 }}>
              Vous dirigez une PME ou une ETI à Toulon, dans le Var ou dans le sud de la région PACA. Althoce vous accompagne avec une expertise sur les secteurs forts régionaux (sous-traitance défense Marine Nationale, Pôle Mer Méditerranée, tourisme Côte d'Azur ouest) et une approche hybride présentiel-distanciel.
            </p>
          ...
          <div className="tln-map-col" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <FranceMapSVG mainCity="Toulon" presentielLabel="Présentiel Toulon" />
          </div>
        </div>
      </div>
    </section>
...
const raisons = [
  ...
  {
    n: '02',
    title: 'Présentiel à Toulon ET distanciel structuré',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Déplacements à Toulon (centre-ville, port, Mourillon), à La Seyne-sur-Mer (Naval Group), à La Garde (technopôle), à Hyères, et plus largement dans le Var (Brignoles, Draguignan sur demande). Pour la phase de build, <strong style={{ color: '#09090b' }}>mode distanciel structuré</strong> avec points hebdomadaires de 30 minutes. Vous choisissez la modalité.
      </p>
    ),
  },
  {
    n: '03',
    title: 'Formation IA pour vos équipes varoises',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        <a href="/services/formation-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Ateliers de formation IA</a> en présentiel à Toulon ou en distanciel synchrone. Formats <strong style={{ color: '#09090b' }}>4h à 21h</strong>, adaptés aux équipes sous-traitance défense (compliance, habilitations), industrie portuaire et tourisme haut de gamme Côte d'Azur ouest.
      </p>
    ),
  },
  {
    n: '04',
    title: 'Souveraineté France par défaut, critique secteur défense',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Mistral hébergé France, infrastructure auto-hébergeable, aucune donnée envoyée à OpenAI ou Anthropic sans accord client documenté. <strong style={{ color: '#09090b' }}>Critère absolu pour le tissu toulonnais</strong> : sous-traitance défense Marine Nationale (Naval Group La Seyne-sur-Mer, secret défense), Pôle Mer Méditerranée (cluster maritime / sous-marin), tourisme haut de gamme (données clients). Voir <a href="/#souverainete" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Souveraineté</a>.
      </p>
    ),
  },
  {
    ...
    <section id="pourquoi" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        <div style={{ marginBottom: 52, opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s ease' }}>
          <H2 style={{ marginBottom: 16 }}>Pourquoi travailler avec Althoce pour votre projet IA à Toulon</H2>
          <p style={{ fontSize: 16, color: '#52525b', lineHeight: 1.7, maxWidth: 640 }}>
            Cinq raisons concrètes qui nous distinguent des autres prestataires IA dans le Var.
          </p>
        </div>
        ...
        <div style={{ marginTop: 48, borderRadius: 20, background: '#09090b', border: '1px solid #1e1e1e', overflow: 'hidden', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s .5s ease' }}>
          ...
          <div style={{ padding: '24px 28px' }}>
            <p style={{ fontSize: 16, color: '#a1a1aa', lineHeight: 1.8, margin: '0 0 16px' }}>
              <strong style={{ color: '#e4e4e7' }}>Mêmes délais, même qualité quel que soit le mode.</strong> Présentiel pertinent pour le cadrage à Toulon (port, centre-ville), La Seyne-sur-Mer ou La Garde. Distanciel pour le build (60 à 70 % du projet) gagne du temps à tout le monde.
            </p>
...
function MetierMockup({ index }: { index: number }) {
  const mockups = [
    // Achats — sous-traitance défense Naval Group
    <div style={{ background: '#09090b', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.18)', border: `1px solid ${AC}30` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        <span style={{ fontSize: 12, fontWeight: 800, color: '#3f3f46', textTransform: 'uppercase', letterSpacing: '.1em' }}>Sous-traitant Naval Group · La Seyne</span>
      ...
      {[{ l: 'Sourcing fournisseur', v: '×6 rapide' }, { l: 'Temps libéré acheteurs', v: '50 %' }, { l: 'Données défense hors France', v: '0' }, { l: 'Déploiement', v: '6 sem.' }].map((r, i) => (
    ...
    // Ops — logistique navale, industrie portuaire
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>ETI Pôle Mer · Toulon</div>
      {[{ l: 'Mails ADV absorbés', v: '×3' }, { l: 'Commandes auto.', v: '100 %' }, { l: 'Souveraineté Mistral', v: '100 % FR' }, { l: 'Turnover ops', v: 'Stoppé' }].map((r, i) => (
    ...
    // Service client — tourisme hôtellerie Côte d'Azur ouest
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>Hôtelier haut de gamme · Hyères</div>
      {[{ l: 'N1 absorbé en autonomie', v: '70 %' }, { l: 'Langues gérées', v: '9 langues' }, { l: 'CSAT', v: '+12 pts' }, { l: 'Disponibilité', v: '24/7' }].map((r, i) => (
        <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '9px 0', borderBottom: i < 3 ? '1px solid #f4f4f5' : 'none' }}>
          <span style={{ fontSize: 13, color: '#52525b', fontWeight: 500 }}>{r.l}</span>
          <span style={{ fontSize: 14, fontWeight: 800, color: AC }}>{r.v}</span>
        </div>
    ...
    // Juridique — cabinets droit maritime et droit défense
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 10 }}>Cabinet droit maritime · Toulon</div>
      {[{ l: 'Contrats pré-analysés/an', v: '600' }, { l: 'Temps juriste libéré', v: '40 %' }, { l: 'Souveraineté Mistral', v: '100 % FR' }, { l: 'Clauses risque détectées', v: '100 %' }].map((r, i) => (
        <div key={i} style={{ marginBottom: 10 }}>
          ...
          <div style={{ height: 4, background: '#f4f4f5', borderRadius: 9999, overflow: 'hidden' }}>
            <div style={{ height: '100%', width: `${[95, 85, 100, 100][i]}%`, background: `linear-gradient(to right,${AC},${AC}88)`, borderRadius: 9999 }} />
          </div>
        </div>
      ))}
    </div>,
...
const metiers = [
  {
    n: '01', href: '/agent-ia/achats/', label: 'Achats (sous-traitance défense, équipementiers naval)', tag: 'Agent IA Achats →',
    desc: "Les directions achats des sous-traitants Naval Group, des équipementiers défense varois et des PME industrielles du Pôle Mer Méditerranée gèrent des panels fournisseurs avec exigences extrêmes (compliance défense, certifications ISO, vigilance financière critique pour les sous-traitants stratégiques). Souveraineté Mistral France obligatoire. Aucune donnée défense hors France. Cas signature : ETI industrielle, +4 % d'économies achats = 1,2 M€ captés.",
    pub: "Sous-traitants Naval Group La Seyne · Équipementiers défense Var · PME Pôle Mer Méditerranée · Industries navales Toulon",
    reverse: false,
  },
  {
    n: '02', href: '/agent-ia/ops/', label: 'Opérations et back-office (logistique navale, industrie portuaire)', tag: 'Agent IA Opérations →',
    desc: "Les ETI industrielles du Pôle Mer Méditerranée et les sous-traitants logistiques portuaires gèrent des flux ADV complexes avec grands donneurs d'ordre (Naval Group, DCNS, autorité portuaire). Notre agent IA absorbe la couche répétitive : traitement commandes, relances, gestion documentaire. Cas signature : distributeur B2B, mails ×3 absorbés, ADV automatisée, fin du turnover ops.",
    pub: "ETI logistique portuaire Toulon · Sous-traitants DCNS · Industries navales Var · PME industrie portuaire La Seyne",
    reverse: true,
  },
  {
    n: '03', href: '/agent-ia/service-client/', label: "Service client (tourisme, hôtellerie Côte d'Azur ouest)", tag: 'Agent IA Service client →',
    desc: "Les hôteliers haut de gamme de Hyères, Saint-Tropez, Bandol et Cassis, et les opérateurs touristiques varois reçoivent des demandes multilingues continues (clientèle européenne et asiatique premium). Notre chatbot IA RAG multilingue absorbe 70 % du N1 en 9 langues et escalade automatiquement pour les demandes complexes. Adapté aux pics saisonniers estivaux. Cas type : SaaS B2B 8 000 clients, CSAT +12 points.",
    pub: "Hôteliers haut de gamme Hyères · Opérateurs touristiques Var · Villages clubs Côte d'Azur · Croisières port Toulon",
    reverse: false,
  },
  {
    n: '04', href: '/agent-ia/juridique/', label: 'Juridique (droit maritime, droit défense, cabinets pro)', tag: 'Agent IA Juridique →',
    desc: "Les cabinets juridiques toulonnais spécialisés en droit maritime et droit défense, et les directions juridiques d'ETI sous-traitantes défense, gèrent des volumes contractuels importants avec contraintes secret défense. Notre agent IA en mode pré-analyse à décharge absorbe la lecture de contrats, détecte les clauses à risque et prépare les annotations. Le juriste décide et signe. L'IA ne publie rien. Souveraineté Mistral France obligatoire. Cas signature : ETI agroalimentaire, 600 contrats/an pré-analysés.",
    pub: "Cabinets droit maritime Toulon · Directions juridiques défense · Avocats droit naval Var · Cabinets pro Toulon",
    reverse: true,
  },
];

function MetiersToulon() {
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto' }}>
        <div style={{ marginBottom: 56 }}>
          <H2 style={{ marginBottom: 12 }}>L'IA transforme chaque métier varois</H2>
          <p style={{ fontSize: 16, color: '#52525b', maxWidth: 640, lineHeight: 1.7 }}>
            Quatre métiers où nos agents IA ont déjà transformé le quotidien de PME et ETI varoises, des sous-traitants Naval Group de La Seyne aux acteurs touristiques de la Côte d'Azur ouest. Pour la liste complète, voir notre <a href="/agent-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>hub agents IA par fonction</a>.
          </p>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 56 }}>
          {metiers.map((m, i) => (
            <div key={i} className={`tln-metier-row${m.reverse ? ' tln-metier-rev' : ''}`}
              ...
              <div style={{ order: m.reverse ? 2 : 1 }}>
                ...
                <div style={{ padding: '10px 16px', borderRadius: 10, background: '#f0f7ff', border: `1px solid ${AC}15`, marginBottom: 20 }}>
                  <div style={{ fontSize: 10, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 4 }}>Public type Toulon / Var</div>
              ...
              <div className="tln-mockup-col" style={{ order: m.reverse ? 1 : 2 }}>
        ...
        <div style={{ marginTop: 64, overflow: 'hidden', borderTop: '1px solid #e4e4e7', paddingTop: 32 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', gap: 10, animation: 'tln-ticker 60s linear infinite', width: 'max-content' }}>
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .6s ease' }}>
        <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.14em', marginBottom: 24 }}>Cas client Var · Anonymisé</div>
        <H2 style={{ marginBottom: 20 }}>Sous-traitant Naval Group La Seyne-sur-Mer : achats automatisés avec compliance défense</H2>

        <div style={{ display: 'inline-flex', flexWrap: 'wrap', gap: 6, marginBottom: 40, padding: '6px 14px', borderRadius: 9999, background: '#f4f4f5' }}>
          {['Sous-traitant Naval Group', '60 collaborateurs', 'La Seyne-sur-Mer', '2025-2026', 'cas anonymisé'].map((t) => (
        ...
        <div className="tln-cas-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.8fr', gap: 48, alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { v: '×6', l: 'sourcing fournisseur plus rapide', hero: true },
              { v: '50 %', l: 'temps libéré pour les acheteurs', hero: false },
              { v: '0', l: 'donnée défense hors France en 12 mois', hero: false },
          ...
          <div>
            <h3 style={{ fontSize: 18, fontWeight: 800, color: '#09090b', marginBottom: 16, lineHeight: 1.3 }}>60 collaborateurs, fournisseur Naval Group, compliance défense et secret industriel non-négociables.</h3>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 20 }}>
              Le sous-traitant Naval Group fournit des équipements à La Seyne-sur-Mer avec une compliance défense stricte (secret défense, contrôles DGA, certification habilitation obligatoire pour tous les fournisseurs). La direction achats, 2 personnes, était saturée par le sourcing manuel et la vérification des certifications. Exigence absolue : aucune donnée ne pouvait quitter le territoire français.
            </p>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 28 }}>
              2 agents IA Althoce déployés en 6 semaines (cadrage présentiel à La Seyne-sur-Mer, build distanciel avec hébergement Mistral OVH France) : un agent sourcing avec critère habilitation défense obligatoire, un agent vigilance financière continue sur 40 sous-traitants critiques. Aujourd'hui, les acheteurs ont libéré 50 % de leur temps pour la négociation stratégique avec Naval Group.
            </p>
            ...
            <div style={{ padding: '20px 24px', borderRadius: 14, background: '#f0f7ff', border: `1px solid ${AC}20`, marginBottom: 24 }}>
              <p style={{ fontSize: 15, color: '#1e3a5f', lineHeight: 1.75, margin: 0, fontStyle: 'italic' }}>
                "On devait trouver des fournisseurs habilités défense rapidement. L'agent le fait en quelques heures. Et on a la certitude absolue que rien n'est sorti de France."
              </p>
              <div style={{ marginTop: 10, fontSize: 13, fontWeight: 700, color: '#52525b' }}>Responsable achats · Sous-traitant Naval Group, La Seyne-sur-Mer</div>
            </div>
  ...
  return (
    <section id="method" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div className="tln-grid4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24 }}>
          {steps.map((s, i) => (
...
const faqToulon = [
  {
    q: "Présentiel à Toulon ou distanciel : quelle différence ?",
    a: "Aucune différence qualité ni délais. Présentiel à Toulon (centre-ville, port, Mourillon), La Seyne-sur-Mer (Naval Group), La Garde ou Hyères pour le cadrage et les ateliers. Build en distanciel structuré avec points hebdomadaires de 30 minutes.",
  },
  {
    q: "Avez-vous un bureau permanent à Toulon ?",
    a: "Pas de bureau permanent. Déplacements réguliers et espaces partenaires centre-ville pour les RDV présentiels. Déplacements réguliers dans le Var (Brignoles, Draguignan sur demande).",
  },
  {
    q: "Proposez-vous des formations IA pour mes équipes varoises ?",
    a: "Oui. Ateliers de formation IA en présentiel à Toulon ou en distanciel synchrone. Formats 4h à 21h, adaptés aux équipes sous-traitance défense (compliance, habilitations), industrie portuaire et tourisme haut de gamme.",
  },
  {
    q: "La souveraineté France est-elle garantie pour la sous-traitance défense (Naval Group) ?",
    a: "Oui, obligatoire et c'est notre standard. Mistral hébergé France (OVH, Scaleway), infrastructure auto-hébergeable possible. Aucune donnée défense ne quitte le territoire français. Documentation conformité fournisseur livrée pour vos donneurs d'ordre défense (Naval Group, DCNS).",
  },
  {
    q: "Avez-vous une expertise tourisme haut de gamme Côte d'Azur ouest (Hyères, Saint-Tropez, Bandol) ?",
    a: "Oui. Chatbot IA multilingue (9 langues), agent téléphonique multilingue, intégration PMS hôteliers. Adapté aux pics saisonniers estivaux et à la clientèle premium européenne et asiatique.",
  },
  {
    q: "Avez-vous des clients dans le Var ?",
    a: "Oui. Sous-traitants défense Naval Group, hôteliers haut de gamme Côte d'Azur ouest, cabinets juridiques spécialisés droit maritime. Notre cas signature achats (sourcing ×6, 50 % temps libéré, 0 donnée hors France) est directement transposable au tissu sous-traitance défense toulonnais.",
  },
];
    ...
    <section id="faq" style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 52 }}>
          <H2 style={{ marginBottom: 12 }}>Questions fréquentes : Althoce à Toulon et dans le Var</H2>
          <p style={{ fontSize: 16, color: '#52525b' }}>Réponses directes aux questions que posent nos prospects varois avant la prise de contact.</p>
        </div>
        <FAQAccordion items={faqToulon} />
      </div>
    </section>
  );
}
...
function Souverainete() {
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#09090b', borderTop: '1px solid #1a1a1a' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        <div className="tln-split-rev" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'center' }}>
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .7s ease' }}>
        ...
        <H2 style={{ marginBottom: 20 }}>
          Prêt à déployer votre premier agent IA<br /><span style={{ color: AC }}>à Toulon ou dans le Var ?</span>
        </H2>
        <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 40, maxWidth: 520, margin: '0 auto 40px' }}>
          Un échange de 30 minutes suffit à identifier le cas d'usage le plus impactant. Repartez avec une feuille de route et un devis ferme sous 5 jours. Présentiel à Toulon ou dans le Var, ou distanciel, que l'on travaille ensemble ou non.
        </p>
...
// ── CSS ───────────────────────────────────────────────────────
const globalStyles = `
  @keyframes tln-drift { 0%,100%{transform:translate(0,0) scale(1)}50%{transform:translate(3%,4%) scale(1.06)} }
  @keyframes tln-ticker { from{transform:translateX(0)}to{transform:translateX(-50%)} }
  ...
  @media (max-width:860px) {
    .tln-hero-grid { grid-template-columns:1fr !important; }
    .tln-map-col { display:none !important; }
    .tln-split-rev { grid-template-columns:1fr !important; }
    .tln-cas-grid { grid-template-columns:1fr !important; }
    .tln-metier-row { grid-template-columns:1fr !important; }
    .tln-metier-rev > div { order:unset !important; }
    .tln-mockup-col { display:none !important; }
    .tln-grid4 { grid-template-columns:repeat(2,1fr) !important; }
  }
  @media (max-width:560px) {
    .tln-grid4 { grid-template-columns:1fr !important; }
  }
`;

export default function AgenceIAToulonPageClient() {
  return (
    <main>
