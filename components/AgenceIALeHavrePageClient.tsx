  ...
  return (
    <section style={{ padding: '120px 24px 80px', position: 'relative', overflow: 'hidden', borderBottom: '1px solid #e4e4e7' }}>
      <div aria-hidden="true" style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
        <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: 600, height: 600, borderRadius: '50%', background: `radial-gradient(circle,${AC}0a 0%,transparent 65%)`, filter: 'blur(80px)', animation: 'lhv-drift 14s ease-in-out infinite' }} />
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1160, margin: '0 auto' }}>
        <div className="lhv-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            <nav aria-label="Breadcrumb" style={{ fontSize: 13, color: '#a1a1aa', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', fontWeight: 500 }}>
              ...
              <span style={{ color: '#09090b' }}>Le Havre</span>
            </nav>

            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 24 }}>
              {['+150 PME équipées en France', 'Expertise logistique portuaire et énergie', 'Présentiel + distanciel'].map((t) => (
            ...
            <h1 style={{ fontSize: 'clamp(26px,3.8vw,50px)', fontWeight: 800, lineHeight: 1.08, letterSpacing: '-.04em', color: '#09090b', marginBottom: 20 }}>
              Agence IA au Havre : agents IA, automatisation et formation pour PME et ETI havraises.
            </h1>

            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 32, maxWidth: 520 }}>
              Vous dirigez une PME ou une ETI au Havre ou en Normandie. Althoce vous accompagne avec une expertise sur les secteurs forts régionaux (logistique portuaire HAROPA Port, transitaires douanes, raffineries TotalEnergies Gonfreville, sous-traitance industrielle) et une approche hybride présentiel-distanciel.
            </p>
          ...
          <div className="lhv-map-col" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <FranceMapSVG mainCity="Le Havre" presentielLabel="Présentiel Le Havre" />
          </div>
        </div>
      </div>
    </section>
...
const raisons = [
  ...
  {
    n: '02',
    title: 'Présentiel au Havre ET distanciel structuré',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Déplacements au Havre (centre-ville, ZIP Port 2000, Pointe de Floride), à Gonfreville-l'Orcher (raffineries TotalEnergies), Montivilliers, et plus largement en Normandie (Rouen via HAROPA Port, Caen sur demande). Pour la phase de build, <strong style={{ color: '#09090b' }}>mode distanciel structuré</strong> avec points hebdomadaires de 30 minutes. Vous choisissez la modalité.
      </p>
    ),
  },
  {
    n: '03',
    title: 'Formation IA pour vos équipes havraises',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        <a href="/services/formation-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Ateliers de formation IA</a> en présentiel au Havre ou en distanciel synchrone. Formats <strong style={{ color: '#09090b' }}>4h à 21h</strong>, adaptés aux métiers portuaires (transitaires, douanes, logistique conteneurs), industriels (sous-traitance raffineries) et aux cabinets professionnels spécialisés droit maritime.
      </p>
    ),
  },
  {
    ...
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Mistral hébergé France, infrastructure auto-hébergeable, aucune donnée envoyée à OpenAI ou Anthropic sans accord client. <strong style={{ color: '#09090b' }}>Critique pour le tissu havrais</strong> : logistique portuaire HAROPA Port (sécurité portuaire, compliance douanière critique), transitaires (manifestes confidentiels, secrets clients), raffineries TotalEnergies (secteur énergie sensible), sous-traitance industrielle portuaire. Voir <a href="/#souverainete" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Souveraineté</a>.
      </p>
    ),
  },
  {
    ...
    <section id="pourquoi" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        <div style={{ marginBottom: 52, opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s ease' }}>
          <H2 style={{ marginBottom: 16 }}>Pourquoi travailler avec Althoce pour votre projet IA au Havre</H2>
          <p style={{ fontSize: 16, color: '#52525b', lineHeight: 1.7, maxWidth: 640 }}>
            Cinq raisons concrètes qui nous distinguent des autres prestataires IA en Normandie.
          </p>
        </div>
        ...
        <div style={{ marginTop: 48, borderRadius: 20, background: '#09090b', border: '1px solid #1e1e1e', overflow: 'hidden', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s .5s ease' }}>
          ...
          <div style={{ padding: '24px 28px' }}>
            <p style={{ fontSize: 16, color: '#a1a1aa', lineHeight: 1.8, margin: '0 0 16px' }}>
              <strong style={{ color: '#e4e4e7' }}>Mêmes délais, même qualité quel que soit le mode.</strong> Présentiel pertinent pour le cadrage au Havre (ZIP Port 2000, centre-ville) ou à Gonfreville-l'Orcher. Distanciel pour le build (60 à 70 % du projet) gagne du temps à tout le monde.
            </p>
...
function MetierMockup({ index }: { index: number }) {
  const mockups = [
    // Ops — gestion documentaire transitaires HAROPA
    <div style={{ background: '#09090b', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.18)', border: `1px solid ${AC}30` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        <span style={{ fontSize: 12, fontWeight: 800, color: '#3f3f46', textTransform: 'uppercase', letterSpacing: '.1em' }}>Transitaire · HAROPA Le Havre</span>
      ...
      {[{ l: 'Manifestes archivés / mois', v: '200' }, { l: 'Retards sur DAU', v: '0' }, { l: 'Mails ops absorbés', v: '×3' }, { l: 'Turnover ops', v: 'Stoppé' }].map((r, i) => (
    ...
    // Achats — sous-traitance portuaire et raffineries
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>ETI portuaire · Gonfreville-l'Orcher</div>
      {[{ l: 'Sourcing fournisseur', v: '×6 rapide' }, { l: 'Économies achats captées', v: '1,2 M€' }, { l: 'Sous-traitants surveillés', v: '80' }, { l: 'Ruptures surprises', v: '0' }].map((r, i) => (
    ...
    // Service client — transitaires multilingue
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>Logisticien portuaire · Le Havre</div>
      {[{ l: 'N1 absorbé en autonomie', v: '70 %' }, { l: 'Langues B2B gérées', v: '9 langues' }, { l: 'CSAT', v: '+12 pts' }, { l: 'Souveraineté Mistral', v: '100 % FR' }].map((r, i) => (
        <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '9px 0', borderBottom: i < 3 ? '1px solid #f4f4f5' : 'none' }}>
          <span style={{ fontSize: 13, color: '#52525b', fontWeight: 500 }}>{r.l}</span>
          <span style={{ fontSize: 14, fontWeight: 800, color: AC }}>{r.v}</span>
        </div>
    ...
    // Téléphonique — cabinets droit maritime, services portuaires
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 10 }}>Cabinet droit maritime · Le Havre</div>
      {[{ l: 'Appels ratés', v: '0' }, { l: 'RDV qualifiés', v: '+130 %' }, { l: 'Standard 24/7', v: 'FR/EN' }, { l: 'Réponse immédiate', v: '< 2 sec' }].map((r, i) => (
        <div key={i} style={{ marginBottom: 10 }}>
          ...
          <div style={{ height: 4, background: '#f4f4f5', borderRadius: 9999, overflow: 'hidden' }}>
            <div style={{ height: '100%', width: `${[100, 100, 90, 95][i]}%`, background: `linear-gradient(to right,${AC},${AC}88)`, borderRadius: 9999 }} />
          </div>
        </div>
      ))}
    </div>,
...
const metiers = [
  {
    n: '01', href: '/agent-ia/ops/', label: 'Opérations et back-office (logistique portuaire, transitaires)', tag: 'Agent IA Opérations →',
    desc: "Les transitaires d'HAROPA Port, les commissionnaires en douane et les acteurs logistiques portuaires havrais gèrent des flux documentaires importants (manifestes, déclarations douanières DAU, BL maritimes, certificats d'origine). Notre agent IA absorbe la gestion documentaire, classe et indexe les documents, et traite les mails entrants. Cas signature : distributeur B2B, mails ×3 absorbés, ADV automatisée, fin du turnover ops.",
    pub: "Transitaires HAROPA Port · Commissionnaires en douane Le Havre · Logisticiens portuaires · Sous-traitants manutention",
    reverse: false,
  },
  {
    n: '02', href: '/agent-ia/achats/', label: 'Achats (sous-traitance portuaire et raffineries)', tag: 'Agent IA Achats →',
    desc: "Les directions achats des ETI portuaires et des sous-traitants raffineries TotalEnergies de Gonfreville-l'Orcher gèrent des panels fournisseurs spécialisés avec exigences fortes (compliance sécurité industrielle SEVESO, certifications, vigilance financière pour sous-traitants critiques). Notre agent IA combine sourcing accéléré et vigilance financière fournisseurs continue. Cas signature : ETI industrielle, +4 % d'économies = 1,2 M€.",
    pub: "Sous-traitants raffineries Gonfreville · ETI portuaires ZIP · Fournisseurs SEVESO · Industries portuaires Normandie",
    reverse: true,
  },
  {
    n: '03', href: '/agent-ia/service-client/', label: 'Service client (transitaires, e-commerce maritime)', tag: 'Agent IA Service client →',
    desc: "Les transitaires et acteurs logistiques portuaires reçoivent des demandes clients multilingues (importateurs, exportateurs, clients européens et internationaux en anglais, espagnol, mandarin, néerlandais). Notre chatbot IA RAG multilingue absorbe le N1 en 9 langues et escalade automatiquement pour les demandes complexes nécessitant une expertise douanière. Cas type : éditeur SaaS B2B 8 000 clients, CSAT +12 points.",
    pub: "Transitaires HAROPA · Logisticiens export-import · E-commerce maritime · Services portuaires Le Havre",
    reverse: false,
  },
  {
    n: '04', href: '/agent-ia/telephonique/', label: 'Téléphonique (cabinets pro, services portuaires)', tag: 'Agent IA Téléphonique →',
    desc: "Les cabinets professionnels havrais (expertise comptable, conseil, avocats spécialisés en droit maritime et droit des transports) et les services portuaires ont des standards téléphoniques saturés. Notre agent IA téléphonique en voix naturelle française et anglaise (espagnol et mandarin sur cadrage pour les acteurs export) prend les appels 24/7 et qualifie chaque demande. Cas signature : cabinet d'avocats, 0 appel raté, +130 % RDV qualifiés.",
    pub: "Cabinets droit maritime Le Havre · Experts-comptables havrais · Avocats transports et douanes · Services portuaires B2B",
    reverse: true,
  },
];

function MetiersLeHavre() {
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto' }}>
        <div style={{ marginBottom: 56 }}>
          <H2 style={{ marginBottom: 12 }}>L'IA transforme chaque métier havrais</H2>
          <p style={{ fontSize: 16, color: '#52525b', maxWidth: 640, lineHeight: 1.7 }}>
            Quatre métiers où nos agents IA ont déjà transformé le quotidien de PME et ETI havraises, des transitaires d'HAROPA Port aux sous-traitants raffineries de Gonfreville. Pour la liste complète, voir notre <a href="/agent-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>hub agents IA par fonction</a>.
          </p>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 56 }}>
          {metiers.map((m, i) => (
            <div key={i} className={`lhv-metier-row${m.reverse ? ' lhv-metier-rev' : ''}`}
              ...
              <div style={{ order: m.reverse ? 2 : 1 }}>
                ...
                <div style={{ padding: '10px 16px', borderRadius: 10, background: '#f0f7ff', border: `1px solid ${AC}15`, marginBottom: 20 }}>
                  <div style={{ fontSize: 10, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 4 }}>Public type Le Havre / Normandie</div>
              ...
              <div className="lhv-mockup-col" style={{ order: m.reverse ? 1 : 2 }}>
        ...
        <div style={{ marginTop: 64, overflow: 'hidden', borderTop: '1px solid #e4e4e7', paddingTop: 32 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', gap: 10, animation: 'lhv-ticker 60s linear infinite', width: 'max-content' }}>
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .6s ease' }}>
        <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.14em', marginBottom: 24 }}>Cas client Normandie · Anonymisé</div>
        <H2 style={{ marginBottom: 20 }}>Transitaire portuaire havrais : gestion documentaire douanière automatisée</H2>

        <div style={{ display: 'inline-flex', flexWrap: 'wrap', gap: 6, marginBottom: 40, padding: '6px 14px', borderRadius: 9999, background: '#f4f4f5' }}>
          {['Transitaire / commissionnaire en douane', '35 collaborateurs', 'Le Havre', '2025-2026', 'cas anonymisé'].map((t) => (
        ...
        <div className="lhv-cas-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.8fr', gap: 48, alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { v: '100 %', l: 'manifestes archivés correctement en autonomie', hero: true },
              { v: '0', l: 'retard sur déclarations DAU', hero: false },
              { v: '×3', l: 'mails ops absorbés par l\'agent', hero: false },
              { v: '6 sem.', l: 'délai de déploiement des 2 agents', hero: false },
            ].map((kpi, i) => (
          ...
          <div>
            <h3 style={{ fontSize: 18, fontWeight: 800, color: '#09090b', marginBottom: 16, lineHeight: 1.3 }}>200 manifestes maritimes par mois, 4 personnes ops saturées, souveraineté absolue exigée.</h3>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 20 }}>
              Le transitaire havrais gère 200 manifestes maritimes par mois, auxquels s'ajoutent les déclarations douanières associées (DAU, certificats d'origine, BL, factures). 4 personnes ops étaient saturées par la gestion documentaire et les mails entrants, au détriment de la relation client et de l'expertise douanière. La souveraineté était non-négociable : données clients confidentielles, manifestes et conditions commerciales sous secret strict.
            </p>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 28 }}>
              2 agents IA Althoce déployés en 6 semaines (cadrage présentiel au Havre, build distanciel avec hébergement Mistral OVH France) : un agent gestion documentaire, un agent mails entrants. Aujourd'hui, le classement et l'indexation se font en autonomie. L'équipe ops est libérée pour la valeur ajoutée : relation client, expertise douanière, développement commercial.
            </p>
            ...
            <div style={{ padding: '20px 24px', borderRadius: 14, background: '#f0f7ff', border: `1px solid ${AC}20`, marginBottom: 24 }}>
              <p style={{ fontSize: 15, color: '#1e3a5f', lineHeight: 1.75, margin: 0, fontStyle: 'italic' }}>
                "On avait 0 retard sur les DAU depuis le déploiement. L'équipe ne passe plus ses journées à chercher des documents. Et les données n'ont jamais quitté la France."
              </p>
              <div style={{ marginTop: 10, fontSize: 13, fontWeight: 700, color: '#52525b' }}>Responsable opérations · Transitaire portuaire havrais</div>
            </div>

            <a href="/cas-clients/distributeur-b2b-agent-ia-ops/" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 700, color: AC, textDecoration: 'none', padding: '10px 20px', border: `1px solid ${AC}30`, borderRadius: 9999, transition: 'all .15s' }}
              onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.background = `${AC}08`; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.background = 'transparent'; }}>
              Lire le cas signature ops →
            </a>
          </div>
        </div>
      </div>
  ...
  return (
    <section id="method" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div className="lhv-grid4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24 }}>
          {steps.map((s, i) => (
...
const faqLeHavre = [
  {
    q: "Présentiel au Havre ou distanciel : quelle différence ?",
    a: "Aucune différence qualité ni délais. Présentiel pertinent au Havre (centre-ville, ZIP Port 2000), à Gonfreville-l'Orcher, Montivilliers ou plus largement en Normandie pour le cadrage et les ateliers. Build en distanciel structuré avec points hebdomadaires de 30 minutes.",
  },
  {
    q: "Avez-vous un bureau permanent au Havre ?",
    a: "Pas de bureau permanent. Déplacements réguliers et espaces partenaires au Havre pour les RDV présentiels. Déplacements réguliers en Normandie (Rouen via HAROPA Port, Caen sur demande).",
  },
  {
    q: "Proposez-vous des formations IA pour mes équipes havraises ?",
    a: "Oui. Ateliers de formation IA en présentiel au Havre ou en distanciel synchrone. Formats 4h à 21h, adaptés aux métiers portuaires (transitaires, douanes, logistique conteneurs), industriels (sous-traitance raffineries) et aux cabinets professionnels spécialisés droit maritime.",
  },
  {
    q: "Avez-vous une expertise sur la logistique portuaire HAROPA Port ?",
    a: "Oui. Sous-traitance HAROPA Port, gestion documentaire douanière (DAU, manifestes, BL maritimes, certificats d'origine), vigilance financière sous-traitants, automatisation ADV export. Souveraineté France obligatoire (compliance douanière critique). Données hébergées Mistral OVH France.",
  },
  {
    q: "La souveraineté France est-elle garantie pour le secteur énergie (TotalEnergies Gonfreville) ?",
    a: "Oui par défaut et sans exception pour les secteurs sensibles. Mistral hébergé France (OVH, Scaleway), infrastructure auto-hébergeable possible. Critique pour le secteur énergie sensible, les données industrielles raffineries et les marchés sous confidentialité clients.",
  },
  {
    q: "Avez-vous des clients en Normandie ?",
    a: "Oui. Transitaires HAROPA Port, sous-traitants industrie portuaire, cabinets professionnels havrais. Notre cas signature ops (200 manifestes/mois automatisés, 0 retard DAU, turnover stoppé) est directement transposable au tissu logistique portuaire havrais.",
  },
];
    ...
    <section id="faq" style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 52 }}>
          <H2 style={{ marginBottom: 12 }}>Questions fréquentes : Althoce au Havre et en Normandie</H2>
          <p style={{ fontSize: 16, color: '#52525b' }}>Réponses directes aux questions que posent nos prospects havrais avant la prise de contact.</p>
        </div>
        <FAQAccordion items={faqLeHavre} />
      </div>
    </section>
  );
}
...
function Souverainete() {
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#09090b', borderTop: '1px solid #1a1a1a' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        <div className="lhv-split-rev" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'center' }}>
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .7s ease' }}>
        ...
        <H2 style={{ marginBottom: 20 }}>
          Prêt à déployer votre premier agent IA<br /><span style={{ color: AC }}>au Havre ou en Normandie ?</span>
        </H2>
        <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 40, maxWidth: 520, margin: '0 auto 40px' }}>
          Un échange de 30 minutes suffit à identifier le cas d'usage le plus impactant. Repartez avec une feuille de route et un devis ferme sous 5 jours. Présentiel au Havre ou en Normandie, ou distanciel, que l'on travaille ensemble ou non.
        </p>
...
// ── CSS ───────────────────────────────────────────────────────
const globalStyles = `
  @keyframes lhv-drift { 0%,100%{transform:translate(0,0) scale(1)}50%{transform:translate(3%,4%) scale(1.06)} }
  @keyframes lhv-ticker { from{transform:translateX(0)}to{transform:translateX(-50%)} }
  ...
  @media (max-width:860px) {
    .lhv-hero-grid { grid-template-columns:1fr !important; }
    .lhv-map-col { display:none !important; }
    .lhv-split-rev { grid-template-columns:1fr !important; }
    .lhv-cas-grid { grid-template-columns:1fr !important; }
    .lhv-metier-row { grid-template-columns:1fr !important; }
    .lhv-metier-rev > div { order:unset !important; }
    .lhv-mockup-col { display:none !important; }
    .lhv-grid4 { grid-template-columns:repeat(2,1fr) !important; }
  }
  @media (max-width:560px) {
    .lhv-grid4 { grid-template-columns:1fr !important; }
  }
`;

export default function AgenceIALeHavrePageClient() {
  return (
    <main>
