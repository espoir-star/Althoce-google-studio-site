  ...
  return (
    <section style={{ padding: '120px 24px 80px', position: 'relative', overflow: 'hidden', borderBottom: '1px solid #e4e4e7' }}>
      <div aria-hidden="true" style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
        <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: 600, height: 600, borderRadius: '50%', background: `radial-gradient(circle,${AC}0a 0%,transparent 65%)`, filter: 'blur(80px)', animation: 'nic-drift 14s ease-in-out infinite' }} />
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1160, margin: '0 auto' }}>
        <div className="nic-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            <nav aria-label="Breadcrumb" style={{ fontSize: 13, color: '#a1a1aa', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', fontWeight: 500 }}>
              ...
              <span style={{ color: '#09090b' }}>Nice</span>
            </nav>

            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 24 }}>
              {['+150 PME équipées en France', 'Expertise tourisme luxe et biotech', 'Multilingue 9 langues'].map((t) => (
            ...
            <h1 style={{ fontSize: 'clamp(26px,3.8vw,50px)', fontWeight: 800, lineHeight: 1.08, letterSpacing: '-.04em', color: '#09090b', marginBottom: 20 }}>
              Agence IA à Nice : agents IA, automatisation et formation pour PME et ETI azuréennes.
            </h1>

            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 32, maxWidth: 520 }}>
              Vous dirigez une PME ou une ETI à Nice, Cannes, Antibes ou sur la Côte d'Azur. Althoce vous accompagne avec une expertise sur les secteurs forts régionaux (hôtellerie haut de gamme, biotech Sophia Antipolis, finance privée, immobilier de prestige) et une approche hybride présentiel-distanciel.
            </p>
          ...
          <div className="nic-map-col" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <FranceMapSVG mainCity="Nice" presentielLabel="Présentiel Nice" />
          </div>
        </div>
      </div>
    </section>
...
const raisons = [
  ...
  {
    n: '02',
    title: 'Présentiel à Nice ET distanciel structuré',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Pour les phases stratégiques (cadrage, ateliers, COMEX), nous nous déplaçons régulièrement à Nice (Promenade des Anglais, centre-ville, Carré d'Or), à Cannes (La Bocca, Croisette), à Antibes et Sophia Antipolis (technopôle), à Monaco sur demande pour les acteurs B2B, et plus largement sur la Côte d'Azur (Saint-Tropez, Menton). Pour la phase de build, <strong style={{ color: '#09090b' }}>mode distanciel structuré</strong> avec points hebdomadaires de 30 minutes. Vous choisissez la modalité.
      </p>
    ),
  },
  {
    ...
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        <a href="/services/formation-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Ateliers de formation IA</a> en présentiel dans vos locaux à Nice, Cannes ou Sophia Antipolis, ou en distanciel synchrone. Formats <strong style={{ color: '#09090b' }}>4h à 21h</strong>, adaptés par métier. Particulièrement adaptés aux équipes hôtellerie multilingues (clientèle internationale VIP) et aux laboratoires biotech (compliance européenne).
      </p>
    ),
  },
  {
    ...
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Mistral hébergé France, infrastructure auto-hébergeable, aucune donnée envoyée à OpenAI ou Anthropic sans accord client. <strong style={{ color: '#09090b' }}>Critique pour le tissu azuréen</strong> : hôtellerie haut de gamme (données clients VIP, secret commercial premium), biotech Sophia Antipolis (recherche clinique, conformité européenne), finance privée (gestion patrimoniale confidentielle), immobilier de prestige (transactions HNW confidentielles). Voir <a href="/#souverainete" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Souveraineté</a>.
      </p>
    ),
  },
  {
    ...
    <section id="pourquoi" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        <div style={{ marginBottom: 52, opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s ease' }}>
          <H2 style={{ marginBottom: 16 }}>Pourquoi travailler avec Althoce pour votre projet IA à Nice</H2>
          <p style={{ fontSize: 16, color: '#52525b', lineHeight: 1.7, maxWidth: 640 }}>
            Cinq raisons concrètes qui nous distinguent des autres prestataires IA sur la Côte d'Azur.
          </p>
        </div>
        ...
        <div style={{ marginTop: 48, borderRadius: 20, background: '#09090b', border: '1px solid #1e1e1e', overflow: 'hidden', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s .5s ease' }}>
          ...
          <div style={{ padding: '24px 28px' }}>
            <p style={{ fontSize: 16, color: '#a1a1aa', lineHeight: 1.8, margin: '0 0 16px' }}>
              <strong style={{ color: '#e4e4e7' }}>Mêmes délais, même qualité quel que soit le mode.</strong> Présentiel pertinent pour le cadrage à Nice (Carré d'Or, Promenade), Cannes ou Sophia Antipolis. Distanciel pour le build (60 à 70 % du projet) gagne du temps à tout le monde.
            </p>
  ...
  const mockups = [
    ...
    <div style={{ background: '#09090b', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.18)', border: `1px solid ${AC}30` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        <span style={{ fontSize: 12, fontWeight: 800, color: '#3f3f46', textTransform: 'uppercase', letterSpacing: '.1em' }}>Hôtel 4* · Cannes-Croisette</span>
      ...
      {[{ l: 'Appels perdus saison haute', v: '0 %' }, { l: 'Langues gérées', v: 'FR/EN/IT/ZH' }, { l: 'Appels autonomie', v: '70 %' }, { l: 'Heures réception libérées/j', v: '8 h' }].map((r, i) => (
    ...
    // Service client tourisme / SaaS Sophia
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>SaaS B2B · Sophia Antipolis</div>
      {[{ l: 'N1 absorbé en autonomie', v: '70 %' }, { l: 'Time-to-response', v: '4 min' }, { l: 'CSAT', v: '+12 pts' }, { l: 'Langues couvertes', v: '9' }].map((r, i) => (
    ...
    // Marketing luxe / agences créatives
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 10 }}>Agence communication · Côte d'Azur</div>
      {[{ l: 'Content produit / 6 mois', v: '×4' }, { l: 'Trafic organique', v: '+140 %' }, { l: 'Posts LinkedIn / mois', v: '4 → 12' }, { l: 'Budget content annulé', v: '60 k€/an' }].map((r, i) => (
        <div key={i} style={{ marginBottom: 10 }}>
          ...
          <div style={{ height: 4, background: '#f4f4f5', borderRadius: 9999, overflow: 'hidden' }}>
            <div style={{ height: '100%', width: `${[90, 80, 72, 65][i]}%`, background: `linear-gradient(to right,${AC},${AC}88)`, borderRadius: 9999 }} />
          </div>
        </div>
      ))}
    </div>,
    // Commercial immobilier / finance privée
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>Immobilier prestige · Nice</div>
      {[{ l: 'RDV qualifiés / 4 mois', v: '+200 %' }, { l: 'Leads non qualifiés filtrés', v: '85 %' }, { l: 'Temps commercial libéré', v: '40 %' }, { l: 'Souveraineté données HNW', v: '100 % FR' }].map((r, i) => (
        <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '9px 0', borderBottom: i < 3 ? '1px solid #f4f4f5' : 'none' }}>
          <span style={{ fontSize: 13, color: '#52525b', fontWeight: 500 }}>{r.l}</span>
          <span style={{ fontSize: 14, fontWeight: 800, color: AC }}>{r.v}</span>
        </div>
...
const metiers = [
  {
    n: '01', href: '/agent-ia/telephonique/', label: "Téléphonique (hôtellerie, cabinets pro, immobilier prestige)", tag: 'Agent IA Téléphonique →',
    desc: "Les hôteliers 4-5 étoiles de la Côte d'Azur (Cannes, Nice, Saint-Tropez), les cabinets professionnels (avocats, gestion de patrimoine) et les agences immobilières de prestige reçoivent des appels multilingues 24/7 (clientèle VIP internationale). Notre agent téléphonique en voix naturelle prend les appels, qualifie, réserve et transfère les cas complexes avec contexte pré-passé. Cas type : 0 appel perdu, 70 % d'appels gérés en autonomie en 4 langues.",
    pub: "Hôtellerie 4-5 étoiles Nice / Cannes / Saint-Tropez · Agences immobilier prestige · Cabinets avocats azuréens · Conciergerie privée Monaco",
    reverse: false,
  },
  {
    n: '02', href: '/agent-ia/service-client/', label: "Service client (tourisme, e-commerce, SaaS Sophia)", tag: 'Agent IA Service client →',
    desc: "Les hôteliers Côte d'Azur, les offices de tourisme régionaux, les e-commerces et les SaaS B2B de Sophia Antipolis gèrent des demandes multilingues en volume. Notre chatbot IA RAG multilingue absorbe 70 % du N1 en 9 langues (FR, EN, IT, DE, ES, NL, PT, mandarin, japonais). Cas type : SaaS B2B Sophia, CSAT +12 points, 0 départ équipe support.",
    pub: "Hôtels Côte d'Azur · Offices de tourisme Nice / Cannes · SaaS B2B Sophia Antipolis · E-commerce azuréen",
    reverse: true,
  },
  {
    n: '03', href: '/agent-ia/marketing/', label: 'Marketing et content (agences créatives, luxe)', tag: 'Agent IA Marketing →',
    desc: "Les agences communication azuréennes, les marques luxe Côte d'Azur et les acteurs hôtellerie 4-5 étoiles doivent produire un contenu premium au ton de marque sans concession qualitative. Notre agent IA marketing produit articles, newsletters et social media en cohérence brand. Cas type : éditeur SaaS B2B, content ×4 sans embauche, trafic organique +140 %.",
    pub: "Agences communication Carré d'Or · Marques luxe azuréennes · Hôtellerie 4-5 étoiles · Scale-up tech Sophia Antipolis",
    reverse: false,
  },
  {
    n: '04', href: '/agent-ia/commercial/', label: 'Commercial (immobilier, finance privée, B2B Sophia)', tag: 'Agent IA Commercial →',
    desc: "Les acteurs immobilier prestige, les gestionnaires de patrimoine et les scale-up B2B de Sophia Antipolis ont des cycles commerciaux longs avec leads inbound à haute valeur. Notre agent IA qualification inbound mène une conversation BANT light, filtre les non-qualifiés et prend les RDV avec le commercial ou conseiller approprié. Cas type : +200 % RDV qualifiés en 4 mois.",
    pub: "Agences immobilier prestige Nice / Cannes · Gestionnaires patrimoine privé · Scale-up B2B Sophia · Cabinets professionnels azuréens",
    reverse: true,
  },
];

function MetiersNice() {
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto' }}>
        <div style={{ marginBottom: 56 }}>
          <H2 style={{ marginBottom: 12 }}>L'IA transforme chaque métier azuréen</H2>
          <p style={{ fontSize: 16, color: '#52525b', maxWidth: 640, lineHeight: 1.7 }}>
            Quatre métiers où nos agents IA ont déjà transformé le quotidien de PME et ETI azuréennes, des hôtels 5 étoiles de la Croisette aux laboratoires biotech de Sophia Antipolis. Pour la liste complète, voir notre <a href="/agent-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>hub agents IA par fonction</a>.
          </p>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 56 }}>
          {metiers.map((m, i) => (
            <div key={i} className={`nic-metier-row${m.reverse ? ' nic-metier-rev' : ''}`}
              ...
              <div style={{ order: m.reverse ? 2 : 1 }}>
                ...
                <div style={{ padding: '10px 16px', borderRadius: 10, background: '#f0f7ff', border: `1px solid ${AC}15`, marginBottom: 20 }}>
                  <div style={{ fontSize: 10, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 4 }}>Public type Côte d'Azur</div>
              ...
              <div className="nic-mockup-col" style={{ order: m.reverse ? 1 : 2 }}>
        ...
        <div style={{ marginTop: 64, overflow: 'hidden', borderTop: '1px solid #e4e4e7', paddingTop: 32 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', gap: 10, animation: 'nic-ticker 60s linear infinite', width: 'max-content' }}>
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .6s ease' }}>
        <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.14em', marginBottom: 24 }}>Cas client azuréen · Anonymisé</div>
        <H2 style={{ marginBottom: 20 }}>Hôtel 4 étoiles Cannes-Croisette : agent IA téléphonique multilingue en 4 semaines</H2>

        <div style={{ display: 'inline-flex', flexWrap: 'wrap', gap: 6, marginBottom: 40, padding: '6px 14px', borderRadius: 9999, background: '#f4f4f5' }}>
          {['Hôtel 4 étoiles', '80 chambres', 'Croisette Cannes', '2025-2026', 'cas anonymisé'].map((t) => (
        ...
        <div className="nic-cas-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.8fr', gap: 48, alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { v: '0 %', l: 'appels perdus en saison haute', hero: true },
              { v: '4 langues', l: 'FR, EN, IT, mandarin en voix naturelle', hero: false },
              { v: '70 %', l: "appels gérés en autonomie", hero: false },
              { v: '8 h/j', l: 'libérées pour la réception humaine en pic', hero: false },
            ].map((k, i) => (
          ...
          <div>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, marginBottom: 20 }}>
              L'hôtel 4 étoiles Cannes-Croisette reçoit en saison haute entre 80 et 150 appels par jour : réservations, demandes concierge, spa, restaurant, gestion plaintes VIP. <strong style={{ color: '#09090b' }}>La réception 6 personnes était saturée, des appels étaient perdus pendant le Festival de Cannes.</strong> Souveraineté France obligatoire (données clients HNW confidentielles).
            </p>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, marginBottom: 28 }}>
              Agent IA téléphonique Althoce déployé en <strong style={{ color: '#09090b' }}>4 semaines</strong> en voix naturelle française, anglaise, italienne et mandarin. Aujourd'hui, 70 % des appels sont gérés en autonomie (informations standard, prises de RDV restaurant, demandes spa). La réception humaine intervient sur les cas VIP et complexes.
            </p>
            <div style={{ padding: '20px 24px', borderRadius: 16, background: '#fafafa', border: '1px solid #e4e4e7', borderLeft: `4px solid ${AC}`, marginBottom: 28 }}>
              ...
              <blockquote style={{ fontSize: 16, fontWeight: 700, color: '#09090b', lineHeight: 1.65, margin: '0 0 10px', fontStyle: 'normal' }}>
                Pendant le Festival, on perdait des appels. Aujourd'hui l'agent gère les demandes courantes en 4 langues, mes équipes se concentrent sur l'expérience VIP. Et nos données clients restent en France, ce n'est pas négociable dans notre secteur.
              </blockquote>
              <div style={{ fontSize: 13, color: '#8a8a95', fontWeight: 600 }}>Directeur général · Hôtel 4 étoiles · Croisette Cannes · 2026</div>
            </div>
            <a href="/cas-clients/cabinet-avocats-agent-ia-telephonique/" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 700, color: AC, textDecoration: 'none', transition: 'gap .15s' }}
              onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.gap = '10px'; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.gap = '6px'; }}>
              Lire le cas signature téléphonique →
            </a>
          </div>
        </div>
      </div>
  ...
  return (
    <section id="method" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div className="nic-grid4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24 }}>
          {steps.map((s, i) => (
...
// ── FAQ locale Nice ───────────────────────────────────────────
const faqNice = [
  { q: "Présentiel ou distanciel à Nice : quelle différence ?", a: "Aucune sur qualité et délais. Présentiel pertinent à Nice (Promenade des Anglais, Carré d'Or), Cannes (Croisette, La Bocca), Antibes-Sophia Antipolis pour le cadrage et les ateliers. Build en distanciel structuré avec points hebdomadaires de 30 minutes. Vous choisissez la modalité selon le projet." },
  { q: "Avez-vous un bureau permanent à Nice ?", a: "Pas de bureau permanent. Déplacements réguliers et espaces partenaires (Sophia Antipolis pour le tech, Carré d'Or pour le luxe) pour les RDV présentiels sur la Côte d'Azur." },
  { q: "Multilingue VIP pour notre clientèle internationale Côte d'Azur ?", a: "Oui. Notre chatbot RAG gère 9 langues standard (FR, EN, IT, DE, ES, NL, PT, mandarin, japonais). Notre agent téléphonique est en voix naturelle française et anglaise par défaut, avec l'italien et le mandarin en option sur cadrage. Particulièrement adapté à l'hôtellerie 4-5 étoiles, l'immobilier prestige et la conciergerie privée." },
  { q: "Avez-vous une expertise hôtellerie haut de gamme Côte d'Azur ?", a: "Oui. Cas types : agent IA téléphonique multilingue 24/7, chatbot RAG multilingue intégré aux PMS hôteliers (Mews, Cloudbeds, Oracle Opera), agent service client tourisme. Adapté aux pics saisonniers (Festival de Cannes, Grand Prix Monaco, été Côte d'Azur). Souveraineté Mistral France obligatoire pour les données clients VIP." },
  { q: "Souveraineté France pour finance privée et immobilier HNW ?", a: "Oui par défaut. Mistral hébergé France (OVH, Scaleway), infrastructure auto-hébergeable. Données clients HNW, transactions immobilières prestige, gestion patrimoniale confidentielle : aucune fuite hors territoire. Documentation conformité RGPD livrée à votre DPO." },
  { q: "Avez-vous des clients sur la Côte d'Azur ?", a: "Oui. Hôtellerie haut de gamme Nice / Cannes / Saint-Tropez, cabinets professionnels azuréens (avocats, expertise comptable), scale-up tech Sophia Antipolis, biotech Sophia. Cas signature téléphonique directement transposable au tissu hôtelier et professionnel azuréen." },
];
    ...
    <section id="faq" style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 52 }}>
          <H2 style={{ marginBottom: 12 }}>Questions fréquentes : Althoce à Nice et sur la Côte d'Azur</H2>
          <p style={{ fontSize: 16, color: '#52525b' }}>Réponses directes aux questions que posent nos prospects azuréens avant la prise de contact.</p>
        </div>
        <FAQAccordion items={faqNice} />
      </div>
    </section>
  );
}
...
function Souverainete() {
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#09090b', borderTop: '1px solid #1a1a1a' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        <div className="nic-split-rev" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'center' }}>
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .7s ease' }}>
        ...
        <H2 style={{ marginBottom: 20 }}>
          Prêt à déployer votre premier agent IA<br /><span style={{ color: AC }}>à Nice ou sur la Côte d'Azur ?</span>
        </H2>
        <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 40, maxWidth: 520, margin: '0 auto 40px' }}>
          Un échange de 30 minutes suffit à identifier le cas d'usage le plus impactant. Repartez avec une feuille de route et un devis ferme sous 5 jours. Présentiel à Nice, Cannes ou Sophia, ou distanciel, que l'on travaille ensemble ou non.
        </p>
...
// ── CSS ───────────────────────────────────────────────────────
const globalStyles = `
  @keyframes nic-drift { 0%,100%{transform:translate(0,0) scale(1)}50%{transform:translate(3%,4%) scale(1.06)} }
  @keyframes floatCard { 0%,100%{transform:translateY(0)}50%{transform:translateY(-6px)} }
  @keyframes nic-ticker { from{transform:translateX(0)}to{transform:translateX(-50%)} }

  @media (max-width:860px) {
    .nic-hero-grid { grid-template-columns:1fr !important; }
    .nic-map-col { display:none !important; }
    .nic-split-rev { grid-template-columns:1fr !important; }
    .nic-cas-grid { grid-template-columns:1fr !important; }
    .nic-metier-row { grid-template-columns:1fr !important; }
    .nic-metier-rev > div { order:unset !important; }
    .nic-mockup-col { display:none !important; }
    .nic-grid4 { grid-template-columns:repeat(2,1fr) !important; }
  }
  @media (max-width:560px) {
    .nic-grid4 { grid-template-columns:1fr !important; }
  }
`;

export default function AgenceIANicePageClient() {
  return (
    <main>
