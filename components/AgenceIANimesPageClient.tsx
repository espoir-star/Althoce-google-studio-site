  ...
  return (
    <section style={{ padding: '120px 24px 80px', position: 'relative', overflow: 'hidden', borderBottom: '1px solid #e4e4e7' }}>
      <div aria-hidden="true" style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
        <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: 600, height: 600, borderRadius: '50%', background: `radial-gradient(circle,${AC}0a 0%,transparent 65%)`, filter: 'blur(80px)', animation: 'nim-drift 14s ease-in-out infinite' }} />
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1160, margin: '0 auto' }}>
        <div className="nim-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            <nav aria-label="Breadcrumb" style={{ fontSize: 13, color: '#a1a1aa', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', fontWeight: 500 }}>
              ...
              <span style={{ color: '#09090b' }}>Nîmes</span>
            </nav>

            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 24 }}>
              {['+150 PME équipées en France', 'Expertise vins et tourisme patrimonial', 'Présentiel + distanciel'].map((t) => (
            ...
            <h1 style={{ fontSize: 'clamp(26px,3.8vw,50px)', fontWeight: 800, lineHeight: 1.08, letterSpacing: '-.04em', color: '#09090b', marginBottom: 20 }}>
              Agence IA à Nîmes : agents IA, automatisation et formation pour PME et ETI nîmoises.
            </h1>

            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 32, maxWidth: 520 }}>
              Vous dirigez une PME ou une ETI à Nîmes, dans le Gard ou en Occitanie côté Méditerranée orientale. Althoce vous accompagne avec une expertise sur les secteurs forts régionaux (vins Costières de Nîmes, agroalimentaire, tourisme patrimonial romain, services aux entreprises) et une approche hybride présentiel-distanciel.
            </p>
          ...
          <div className="nim-map-col" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <FranceMapSVG mainCity="Nîmes" presentielLabel="Présentiel Nîmes" />
          </div>
        </div>
      </div>
    </section>
...
const raisons = [
  ...
  {
    n: '02',
    title: 'Présentiel à Nîmes ET distanciel structuré',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Déplacements à Nîmes (centre-ville Écusson, Hoche, Marché Gare technopôle), à Alès, à Bagnols-sur-Cèze, et plus largement dans le Gard et l'arc méditerranéen Occitanie (Montpellier, Avignon, Arles sur demande). Pour la phase de build, <strong style={{ color: '#09090b' }}>mode distanciel structuré</strong> avec points hebdomadaires de 30 minutes. Vous choisissez la modalité.
      </p>
    ),
  },
  {
    n: '03',
    title: 'Formation IA pour vos équipes nîmoises',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        <a href="/services/formation-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Ateliers de formation IA</a> en présentiel à Nîmes ou en distanciel synchrone. Formats <strong style={{ color: '#09090b' }}>4h à 21h</strong>, adaptés aux équipes viticoles Costières, agroalimentaires gardoises et acteurs du tourisme patrimonial.
      </p>
    ),
  },
  {
    ...
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Mistral hébergé France, infrastructure auto-hébergeable, aucune donnée envoyée à OpenAI ou Anthropic sans accord client. <strong style={{ color: '#09090b' }}>Critique pour le tissu nîmois</strong> : <strong>vins Costières de Nîmes</strong> (secret commercial, allocations primeurs), <strong>agroalimentaire gardois</strong> (normes sanitaires européennes, recettes propriétaires), <strong>tourisme patrimonial</strong> (données clients internationaux). Voir <a href="/#souverainete" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Souveraineté</a>.
      </p>
    ),
  },
  {
    ...
    <section id="pourquoi" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        <div style={{ marginBottom: 52, opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s ease' }}>
          <H2 style={{ marginBottom: 16 }}>Pourquoi travailler avec Althoce pour votre projet IA à Nîmes</H2>
          <p style={{ fontSize: 16, color: '#52525b', lineHeight: 1.7, maxWidth: 640 }}>
            Cinq raisons concrètes qui nous distinguent des autres prestataires IA dans le Gard.
          </p>
        </div>
        ...
        <div style={{ marginTop: 48, borderRadius: 20, background: '#09090b', border: '1px solid #1e1e1e', overflow: 'hidden', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s .5s ease' }}>
          ...
          <div style={{ padding: '24px 28px' }}>
            <p style={{ fontSize: 16, color: '#a1a1aa', lineHeight: 1.8, margin: '0 0 16px' }}>
              <strong style={{ color: '#e4e4e7' }}>Mêmes délais, même qualité quel que soit le mode.</strong> Présentiel pertinent pour le cadrage à Nîmes (Écusson, Marché Gare) ou dans le Gard. Distanciel pour le build (60 à 70 % du projet) gagne du temps à tout le monde.
            </p>
...
function MetierMockup({ index }: { index: number }) {
  const mockups = [
    // Service client multilingue — tourisme patrimonial
    <div style={{ background: '#09090b', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.18)', border: `1px solid ${AC}30` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        <span style={{ fontSize: 12, fontWeight: 800, color: '#3f3f46', textTransform: 'uppercase', letterSpacing: '.1em' }}>Tourisme patrimonial · Nîmes</span>
      ...
      {[{ l: 'N1 absorbé en autonomie', v: '70 %' }, { l: 'Langues couvertes', v: '9' }, { l: 'CSAT après déploiement', v: '+12 pts' }, { l: 'Disponibilité', v: '24/7' }].map((r, i) => (
    ...
    // Commercial export — vins Costières
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>Vignoble Costières · Nîmes</div>
      {[{ l: 'RDV qualifiés importateurs', v: '+150 %' }, { l: 'Nouveaux comptes export', v: '3' }, { l: 'Langues prospection', v: 'FR/EN/DE' }, { l: 'Déploiement', v: '6 sem.' }].map((r, i) => (
    ...
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>SaaS B2B · Occitanie</div>
    ...
    // Finance — cabinets comptables Nîmes
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 10 }}>Cabinet comptable · Nîmes</div>
      {[{ l: 'Capacité traitée', v: '×2' }, { l: 'Saisie automatisée', v: '80 %' }, { l: 'Délai clôture', v: '−40 %' }, { l: 'Déploiement', v: '4 mois' }].map((r, i) => (
        <div key={i} style={{ marginBottom: 10 }}>
          ...
          <div style={{ height: 4, background: '#f4f4f5', borderRadius: 9999, overflow: 'hidden' }}>
            <div style={{ height: '100%', width: `${[100, 95, 85, 100][i]}%`, background: `linear-gradient(to right,${AC},${AC}88)`, borderRadius: 9999 }} />
          </div>
        </div>
      ))}
    </div>,
...
const metiers = [
  {
    n: '01', href: '/agent-ia/service-client/', label: 'Service client multilingue (tourisme patrimonial, hôtellerie)', tag: 'Agent IA Service client →',
    desc: "Les opérateurs touristiques nîmois (Arènes de Nîmes, Maison Carrée, Pont du Gard), les hôteliers de la métropole et les acteurs du tourisme patrimonial reçoivent des demandes multilingues continues tout au long de l'année, avec des pics fériaux et festivaliers importants. Notre chatbot IA RAG multilingue absorbe 70 % du N1 en 9 langues, intégré aux systèmes de billetterie et de réservation. Cas type : CSAT +12 points.",
    pub: "Opérateurs tourisme Nîmes · Hôteliers Gard · Sites patrimoniaux Occitanie · Offices de tourisme",
    reverse: false,
  },
  {
    n: '02', href: '/agent-ia/commercial/', label: 'Commercial export (vins Costières, agroalimentaire premium)', tag: 'Agent IA Commercial →',
    desc: "Les vignerons et négoces Costières de Nîmes et les acteurs agroalimentaires gardois (huiles d'olive, produits méditerranéens, oignons doux Cévennes AOP) ont une activité export significative. Notre agent IA SDR prospecte 24/7 en français, anglais et allemand les importateurs, cavistes haut de gamme et distributeurs européens. Cas signature : négoce de vins, +150 % RDV qualifiés importateurs, 3 nouveaux comptes en 6 mois.",
    pub: "Vignerons Costières de Nîmes · Coopératives viticoles Gard · Acteurs agroalimentaire méditerranéen · Négoces Occitanie",
    reverse: true,
  },
  {
    n: '03', href: '/agent-ia/marketing/', label: 'Marketing et content (vins, agroalimentaire, héritage)', tag: 'Agent IA Marketing →',
    desc: "Les vignerons Costières, les acteurs agroalimentaires gardois et les prestataires touristiques nîmois doivent produire un contenu premium au ton de marque (storytelling terroir méditerranéen, héritage romain, AOC). Notre agent IA marketing génère articles SEO, newsletters, posts sociaux et fiches produit en cohérence brand. Cas type : éditeur SaaS B2B, content ×4 sans embauche, trafic organique +140 %.",
    pub: "Vignobles Costières de Nîmes · Acteurs agrotourisme Gard · Agences marketing Nîmes · PME agroalimentaire Occitanie",
    reverse: false,
  },
  {
    n: '04', href: '/agent-ia/finance/', label: 'Finance et comptabilité (cabinets pro Nîmes)', tag: 'Agent IA Finance →',
    desc: "Les cabinets d'expertise comptable nîmois (forte densité Écusson et Hoche) et les directions financières d'ETI gardoises absorbent 60 à 80 % de saisie répétitive (OCR factures, rapprochement bancaire, reporting de gestion). Notre agent IA automatise les flux comptables et génère les tableaux de bord de gestion. Cas signature : cabinet d'expertise comptable, ×2 capacité traitée en 4 mois sans embauche.",
    pub: "Cabinets expertise comptable Nîmes · Directions financières ETI Gard · Cabinets gestion Occitanie",
    reverse: true,
  },
];

function MetiersNimes() {
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto' }}>
        <div style={{ marginBottom: 56 }}>
          <H2 style={{ marginBottom: 12 }}>L'IA transforme chaque métier nîmois</H2>
          <p style={{ fontSize: 16, color: '#52525b', maxWidth: 640, lineHeight: 1.7 }}>
            Quatre métiers où nos agents IA ont déjà transformé le quotidien de PME et ETI nîmoises, des vignerons des Costières aux acteurs du tourisme romain. Pour la liste complète, voir notre <a href="/agent-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>hub agents IA par fonction</a>.
          </p>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 56 }}>
          {metiers.map((m, i) => (
            <div key={i} className={`nim-metier-row${m.reverse ? ' nim-metier-rev' : ''}`}
              ...
              <div style={{ order: m.reverse ? 2 : 1 }}>
                ...
                <div style={{ padding: '10px 16px', borderRadius: 10, background: '#f0f7ff', border: `1px solid ${AC}15`, marginBottom: 20 }}>
                  <div style={{ fontSize: 10, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 4 }}>Public type Nîmes / Gard</div>
              ...
              <div className="nim-mockup-col" style={{ order: m.reverse ? 1 : 2 }}>
        ...
        <div style={{ marginTop: 64, overflow: 'hidden', borderTop: '1px solid #e4e4e7', paddingTop: 32 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', gap: 10, animation: 'nim-ticker 60s linear infinite', width: 'max-content' }}>
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .6s ease' }}>
        <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.14em', marginBottom: 24 }}>Cas client Gard · Anonymisé</div>
        <H2 style={{ marginBottom: 20 }}>Vignoble Costières de Nîmes : +150 % de RDV importateurs européens en 6 semaines</H2>

        <div style={{ display: 'inline-flex', flexWrap: 'wrap', gap: 6, marginBottom: 40, padding: '6px 14px', borderRadius: 9999, background: '#f4f4f5' }}>
          {['Vignoble Costières de Nîmes', '25 collaborateurs', 'Nîmes', '2025-2026', 'cas anonymisé'].map((t) => (
        ...
        <div className="nim-cas-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.8fr', gap: 48, alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { v: '+150 %', l: 'RDV qualifiés importateurs européens', hero: true },
              { v: '3', l: 'nouveaux comptes distributeurs vins méditerranéens', hero: false },
              { v: '24/7', l: 'prospection FR, EN, DE', hero: false },
          ...
          <div>
            <h3 style={{ fontSize: 18, fontWeight: 800, color: '#09090b', marginBottom: 16, lineHeight: 1.3 }}>25 collaborateurs, production 200 000 bouteilles/an, ambition export vers UK, Allemagne et USA sans commercial multilingue sur place.</h3>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 20 }}>
              Le vignoble Costières de Nîmes produisait une gamme reconnue mais sans débouché export structuré. Recruter un commercial bilingue sur place : trop coûteux et trop long. Agent IA SDR multilingue Althoce déployé en 6 semaines (FR, EN, DE). L'agent prospecte désormais 24/7 sur LinkedIn et par email les importateurs et cavistes haut de gamme européens.
            </p>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 28 }}>
              La directrice commerciale a ouvert 3 nouveaux comptes distributeurs vins méditerranéens en 6 mois (UK, Allemagne, Pays-Bas). Les données restent hébergées en France (Mistral OVH). Secret commercial sur les allocations et primeurs garanti.
            </p>
            ...
            <div style={{ padding: '20px 24px', borderRadius: 14, background: '#f0f7ff', border: `1px solid ${AC}20`, marginBottom: 24 }}>
              <p style={{ fontSize: 15, color: '#1e3a5f', lineHeight: 1.75, margin: 0, fontStyle: 'italic' }}>
                "On n'avait pas les moyens d'un commercial export à temps plein. L'agent prospecte comme un junior très organisé qui ne dort pas. Trois comptes UK et Allemagne en six mois : on ne s'y attendait pas si vite."
              </p>
              <div style={{ marginTop: 10, fontSize: 13, fontWeight: 700, color: '#52525b' }}>Directrice commerciale · Vignoble Costières de Nîmes</div>
            </div>
  ...
  return (
    <section id="method" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div className="nim-grid4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24 }}>
          {steps.map((s, i) => (
...
const faqNimes = [
  {
    q: "Présentiel à Nîmes ou distanciel : quelle différence ?",
    a: "Aucune différence qualité ni délais. Présentiel à Nîmes (centre-ville Écusson, Hoche, Marché Gare), Alès ou dans le Gard pour le cadrage et les ateliers. Build en distanciel structuré avec points hebdomadaires de 30 minutes.",
  },
  {
    q: "Avez-vous un bureau permanent à Nîmes ?",
    a: "Pas de bureau permanent. Déplacements réguliers et espaces partenaires Marché Gare pour les RDV présentiels. Déplacements réguliers dans le Gard et l'arc méditerranéen Occitanie (Montpellier, Avignon sur demande).",
  },
  {
    q: "Proposez-vous des formations IA pour mes équipes nîmoises ?",
    a: "Oui. Ateliers de formation IA en présentiel à Nîmes ou en distanciel synchrone. Formats 4h à 21h, adaptés aux équipes viticoles Costières, agroalimentaire gardois et tourisme patrimonial.",
  },
  {
    q: "Avez-vous une expertise tourisme patrimonial romain (Arènes, Maison Carrée, Pont du Gard) ?",
    a: "Oui. Cas types : chatbot RAG multilingue en 9 langues pour visiteurs internationaux, agent IA téléphonique multilingue, intégration aux systèmes de billetterie et réservation. Adapté aux pics saisonniers, festivals et ferias.",
  },
  {
    q: "Mes données restent-elles en France ?",
    a: "Oui par défaut. Mistral hébergé France (OVH, Scaleway). Critique pour les vins Costières de Nîmes (secret commercial, allocations), l'agroalimentaire premium (normes sanitaires européennes) et les données clients tourisme international.",
  },
  {
    q: "Avez-vous des clients dans le Gard ?",
    a: "Oui. Vignobles Costières de Nîmes, acteurs agroalimentaires gardois, cabinets pro nîmois. Notre cas signature commercial export (négoce de vins, +150 % RDV importateurs européens, 3 nouveaux comptes en 6 mois) est directement transposable au tissu viticole gardois.",
  },
];
    ...
    <section id="faq" style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 52 }}>
          <H2 style={{ marginBottom: 12 }}>Questions fréquentes : Althoce à Nîmes et dans le Gard</H2>
          <p style={{ fontSize: 16, color: '#52525b' }}>Réponses directes aux questions que posent nos prospects nîmois avant la prise de contact.</p>
        </div>
        <FAQAccordion items={faqNimes} />
      </div>
    </section>
  );
}
...
function Souverainete() {
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#09090b', borderTop: '1px solid #1a1a1a' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        <div className="nim-split-rev" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'center' }}>
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .7s ease' }}>
        ...
        <H2 style={{ marginBottom: 20 }}>
          Prêt à déployer votre premier agent IA<br /><span style={{ color: AC }}>à Nîmes ou dans le Gard ?</span>
        </H2>
        <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 40, maxWidth: 520, margin: '0 auto 40px' }}>
          Un échange de 30 minutes suffit à identifier le cas d'usage le plus impactant. Repartez avec une feuille de route et un devis ferme sous 5 jours. Présentiel à Nîmes ou dans le Gard, ou distanciel, que l'on travaille ensemble ou non.
        </p>
...
const globalStyles = `
  ...
  @media (max-width:860px) {
    ...
    .nim-map-col { display:none !important; }
    .nim-split-rev { grid-template-columns:1fr !important; }
    .nim-cas-grid { grid-template-columns:1fr !important; }
    .nim-metier-row { grid-template-columns:1fr !important; }
    .nim-metier-rev > div { order:unset !important; }
    .nim-mockup-col { display:none !important; }
    .nim-grid4 { grid-template-columns:repeat(2,1fr) !important; }
  }
  @media (max-width:560px) {
    .nim-grid4 { grid-template-columns:1fr !important; }
  }
`;

export default function AgenceIANimesPageClient() {
  return (
    <main>
