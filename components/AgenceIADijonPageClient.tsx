  ...
  return (
    <section style={{ padding: '120px 24px 80px', position: 'relative', overflow: 'hidden', borderBottom: '1px solid #e4e4e7' }}>
      <div aria-hidden="true" style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
        <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: 600, height: 600, borderRadius: '50%', background: `radial-gradient(circle,${AC}0a 0%,transparent 65%)`, filter: 'blur(80px)', animation: 'dij-drift 14s ease-in-out infinite' }} />
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1160, margin: '0 auto' }}>
        <div className="dij-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            <nav aria-label="Breadcrumb" style={{ fontSize: 13, color: '#a1a1aa', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', fontWeight: 500 }}>
              ...
              <span style={{ color: '#09090b' }}>Dijon</span>
            </nav>

            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 24 }}>
              {['+150 PME équipées en France', 'Expertise agroalimentaire premium et vins', 'Présentiel + distanciel'].map((t) => (
            ...
            <h1 style={{ fontSize: 'clamp(26px,3.8vw,50px)', fontWeight: 800, lineHeight: 1.08, letterSpacing: '-.04em', color: '#09090b', marginBottom: 20 }}>
              Agence IA à Dijon : agents IA, automatisation et formation pour PME et ETI bourguignonnes.
            </h1>

            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 32, maxWidth: 520 }}>
              Vous dirigez une PME ou une ETI à Dijon, en Côte-d'Or ou en Bourgogne-Franche-Comté. Althoce vous accompagne avec une expertise sur les secteurs forts régionaux (agroalimentaire premium, négoces de vins de Bourgogne, pharma régionale) et une approche hybride présentiel-distanciel.
            </p>
          ...
          <div className="dij-map-col" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <FranceMapSVG mainCity="Dijon" presentielLabel="Présentiel Dijon" />
          </div>
        </div>
      </div>
    </section>
...
const raisons = [
  ...
  {
    n: '02',
    title: 'Présentiel à Dijon ET distanciel structuré',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Déplacements à Dijon (centre-ville Ducal, Toison d'Or, technopôle Mazen-Sully), à Beaune (négoces de vins de Bourgogne), à Chenôve, et plus largement en Côte-d'Or et Bourgogne-Franche-Comté (Mâcon via la Saône-et-Loire, Besançon sur demande). Pour la phase de build, <strong style={{ color: '#09090b' }}>mode distanciel structuré</strong> avec points hebdomadaires de 30 minutes. Vous choisissez la modalité.
      </p>
    ),
  },
  {
    n: '03',
    title: 'Formation IA pour vos équipes bourguignonnes',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        <a href="/services/formation-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Ateliers de formation IA</a> en présentiel à Dijon ou en distanciel synchrone. Formats <strong style={{ color: '#09090b' }}>4h à 21h</strong>, adaptés aux équipes agroalimentaire premium, négoces de vins de Bourgogne et pharma régionale.
      </p>
    ),
  },
  {
    ...
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Mistral hébergé France, infrastructure auto-hébergeable, aucune donnée envoyée à OpenAI ou Anthropic sans accord client. <strong style={{ color: '#09090b' }}>Critique pour le tissu dijonnais</strong> : <strong>agroalimentaire premium</strong> (moutarde Maille / Amora, gastronomie bourguignonne, normes sanitaires européennes), <strong>négoces de vins de Bourgogne</strong> (Côte de Nuits, Côte de Beaune, Chablis : secret commercial sur allocations premiers crus et grands crus), <strong>pharma régionale</strong>. Voir <a href="/#souverainete" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Souveraineté</a>.
      </p>
    ),
  },
  {
    ...
    <section id="pourquoi" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        <div style={{ marginBottom: 52, opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s ease' }}>
          <H2 style={{ marginBottom: 16 }}>Pourquoi travailler avec Althoce pour votre projet IA à Dijon</H2>
          <p style={{ fontSize: 16, color: '#52525b', lineHeight: 1.7, maxWidth: 640 }}>
            Cinq raisons concrètes qui nous distinguent des autres prestataires IA en Bourgogne-Franche-Comté.
          </p>
        </div>
        ...
        <div style={{ marginTop: 48, borderRadius: 20, background: '#09090b', border: '1px solid #1e1e1e', overflow: 'hidden', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s .5s ease' }}>
          ...
          <div style={{ padding: '24px 28px' }}>
            <p style={{ fontSize: 16, color: '#a1a1aa', lineHeight: 1.8, margin: '0 0 16px' }}>
              <strong style={{ color: '#e4e4e7' }}>Mêmes délais, même qualité quel que soit le mode.</strong> Présentiel pertinent pour le cadrage à Dijon (centre-ville Ducal) ou Beaune (négoces de vins). Distanciel pour le build (60 à 70 % du projet) gagne du temps à tout le monde.
            </p>
...
function MetierMockup({ index }: { index: number }) {
  const mockups = [
    // Commercial export — négoce de vins
    <div style={{ background: '#09090b', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.18)', border: `1px solid ${AC}30` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        <span style={{ fontSize: 12, fontWeight: 800, color: '#3f3f46', textTransform: 'uppercase', letterSpacing: '.1em' }}>Négoce vins · Beaune</span>
      ...
      {[{ l: 'RDV qualifiés asiatiques', v: '+180 %' }, { l: 'Nouveaux comptes grand cru', v: '5' }, { l: 'Langues prospection', v: 'FR/EN/ZH/JA' }, { l: 'Déploiement', v: '6 sem.' }].map((r, i) => (
    ...
    // Marketing — vins et agroalimentaire
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>SaaS B2B · Bourgogne</div>
    ...
    // Achats — matières premières agroalimentaire
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>ETI industrielle · Bourgogne</div>
    ...
    // Service client multilingue — export viticole
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 10 }}>SaaS B2B · Export viticole</div>
      {[{ l: 'CSAT après déploiement', v: '+12 pts' }, { l: 'Langues couvertes', v: '9' }, { l: 'N1 absorbé en autonomie', v: '70 %' }, { l: 'Disponibilité', v: '24/7' }].map((r, i) => (
        <div key={i} style={{ marginBottom: 10 }}>
          ...
          <div style={{ height: 4, background: '#f4f4f5', borderRadius: 9999, overflow: 'hidden' }}>
            <div style={{ height: '100%', width: `${[90, 100, 95, 100][i]}%`, background: `linear-gradient(to right,${AC},${AC}88)`, borderRadius: 9999 }} />
          </div>
        </div>
      ))}
    </div>,
...
const metiers = [
  {
    n: '01', href: '/agent-ia/commercial/', label: 'Commercial export (négoces de vins, agroalimentaire premium)', tag: 'Agent IA Commercial →',
    desc: "Les négoces de vins de Bourgogne (Beaune, Nuits-Saint-Georges, Meursault, Pommard) et les acteurs agroalimentaires premium dijonnais ont une activité export significative avec prospection multilingue. Notre agent IA SDR prospecte 24/7 sur LinkedIn et email en français, anglais, mandarin et japonais. Cas signature : négoce de vins, +180 % RDV qualifiés importateurs asiatiques, 5 nouveaux comptes grands crus ouverts en 6 mois.",
    pub: "Négoces de vins Beaune · Acteurs agroalimentaire premium dijonnais · Exportateurs gastronomie bourguignonne · ETI agro Côte-d'Or",
    reverse: false,
  },
  {
    n: '02', href: '/agent-ia/marketing/', label: 'Marketing et content (vins de Bourgogne, agroalimentaire premium)', tag: 'Agent IA Marketing →',
    desc: "Les négoces de vins de Bourgogne, les acteurs agroalimentaires premium et les agences communication dijonnaises doivent produire un contenu premium au ton de marque (storytelling terroir bourguignon, héritage, qualité). Notre agent IA marketing génère le contenu en cohérence brand, adapté à l'audience importateurs, cavistes haut de gamme et restaurateurs étoilés. Cas type : éditeur SaaS B2B, content ×4 sans embauche, trafic organique +140 %.",
    pub: "Négoces de vins de Bourgogne · Agroalimentaire premium Dijon · Agences marketing Côte-d'Or · PME gastronomie bourguignonne",
    reverse: true,
  },
  {
    n: '03', href: '/agent-ia/achats/', label: 'Achats (matières premières premium, sourcing agroalimentaire)', tag: 'Agent IA Achats →',
    desc: "Les directions achats des acteurs agroalimentaires premium dijonnais et des ETI industrielles bourguignonnes gèrent des panels fournisseurs spécialisés (matières premières premium, packaging, services logistiques). Notre agent IA combine sourcing accéléré, analyse devis pondérée par qualité et surveillance financière continue des fournisseurs. Cas signature : ETI industrielle, +4 % d'économies achats.",
    pub: "ETI agroalimentaire Dijon · Acteurs moutarde et gastronomie · Industries Côte-d'Or · PME Bourgogne-Franche-Comté",
    reverse: false,
  },
  {
    n: '04', href: '/agent-ia/service-client/', label: 'Service client multilingue (export viticole, gastronomie)', tag: 'Agent IA Service client →',
    desc: "Les négoces de vins de Bourgogne et les acteurs gastronomie bourguignonne gèrent une clientèle internationale (importateurs, cavistes haut de gamme, restaurants étoilés, distributeurs). Notre chatbot IA RAG multilingue absorbe les demandes B2B en 9 langues, intégré aux fiches produit et aux documentations d'allocations. Souveraineté France obligatoire. Secret commercial sur allocations premiers crus et grands crus garanti. Cas type : CSAT +12 points.",
    pub: "Négoces de vins Beaune · Maisons gastronomie bourguignonne · Caves coopératives · Domaines viticoles Côte-d'Or",
    reverse: true,
  },
];

function MetiersDijon() {
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto' }}>
        <div style={{ marginBottom: 56 }}>
          <H2 style={{ marginBottom: 12 }}>L'IA transforme chaque métier dijonnais</H2>
          <p style={{ fontSize: 16, color: '#52525b', maxWidth: 640, lineHeight: 1.7 }}>
            Quatre métiers où nos agents IA ont déjà transformé le quotidien de PME et ETI bourguignonnes, des négoces de vins de Beaune aux acteurs agroalimentaires premium dijonnais. Pour la liste complète, voir notre <a href="/agent-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>hub agents IA par fonction</a>.
          </p>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 56 }}>
          {metiers.map((m, i) => (
            <div key={i} className={`dij-metier-row${m.reverse ? ' dij-metier-rev' : ''}`}
              ...
              <div style={{ order: m.reverse ? 2 : 1 }}>
                ...
                <div style={{ padding: '10px 16px', borderRadius: 10, background: '#f0f7ff', border: `1px solid ${AC}15`, marginBottom: 20 }}>
                  <div style={{ fontSize: 10, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 4 }}>Public type Dijon / Bourgogne</div>
              ...
              <div className="dij-mockup-col" style={{ order: m.reverse ? 1 : 2 }}>
        ...
        <div style={{ marginTop: 64, overflow: 'hidden', borderTop: '1px solid #e4e4e7', paddingTop: 32 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', gap: 10, animation: 'dij-ticker 60s linear infinite', width: 'max-content' }}>
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .6s ease' }}>
        <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.14em', marginBottom: 24 }}>Cas client Bourgogne · Anonymisé</div>
        <H2 style={{ marginBottom: 20 }}>Négoce de vins de Bourgogne : +180 % de RDV importateurs asiatiques en 6 semaines</H2>

        <div style={{ display: 'inline-flex', flexWrap: 'wrap', gap: 6, marginBottom: 40, padding: '6px 14px', borderRadius: 9999, background: '#f4f4f5' }}>
          {['Négoce de vins de Bourgogne', '40 collaborateurs', 'Beaune', '2025-2026', 'cas anonymisé'].map((t) => (
        ...
        <div className="dij-cas-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.8fr', gap: 48, alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { v: '+180 %', l: 'RDV qualifiés importateurs asiatiques', hero: true },
              { v: '5', l: 'nouveaux comptes grands crus exportés', hero: false },
              { v: '24/7', l: 'prospection FR, EN, ZH, JA', hero: false },
              { v: '6 sem.', l: 'de la signature au déploiement', hero: false },
            ].map((kpi, i) => (
          ...
          <div>
            <h3 style={{ fontSize: 18, fontWeight: 800, color: '#09090b', marginBottom: 16, lineHeight: 1.3 }}>40 collaborateurs, sélection de domaines Côte de Nuits et Côte de Beaune pour importateurs et cavistes haut de gamme internationaux.</h3>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 20 }}>
              Le négoce de vins de Beaune (sélection de domaines Côte de Nuits, Côte de Beaune, Chablis pour importateurs et cavistes haut de gamme) ne disposait pas de commercial mandarin ni japonais à Beaune. Recruter sur place : impossible. Un agent IA SDR multilingue Althoce a été déployé en 6 semaines. Aujourd'hui, l'agent prospecte 24/7 sur LinkedIn et email les importateurs et cavistes haut de gamme asiatiques.
            </p>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 28 }}>
              La directrice export a ouvert 5 nouveaux comptes premier cru / grand cru en 6 mois. Toutes les données restent hébergées en France (Mistral OVH). Secret commercial sur les allocations grands crus garanti.
            </p>
            ...
            <div style={{ padding: '20px 24px', borderRadius: 14, background: '#f0f7ff', border: `1px solid ${AC}20`, marginBottom: 24 }}>
              <p style={{ fontSize: 15, color: '#1e3a5f', lineHeight: 1.75, margin: 0, fontStyle: 'italic' }}>
                "Je n'avais pas de commercial mandarin à Beaune. Maintenant j'en ai un qui travaille 24/7 et qui connaît tous mes domaines. Cinq nouveaux comptes grands crus en 6 mois, dont deux au Japon."
              </p>
              <div style={{ marginTop: 10, fontSize: 13, fontWeight: 700, color: '#52525b' }}>Directrice export · Négoce de vins de Bourgogne, Beaune</div>
            </div>
  ...
  return (
    <section id="method" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div className="dij-grid4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24 }}>
          {steps.map((s, i) => (
...
const faqDijon = [
  {
    q: "Présentiel à Dijon ou distanciel : quelle différence ?",
    a: "Aucune différence qualité ni délais. Présentiel à Dijon (centre-ville Ducal, Toison d'Or, technopôle Mazen-Sully), Beaune (négoces) ou Chenôve pour le cadrage et les ateliers. Build en distanciel structuré avec points hebdomadaires de 30 minutes.",
  },
  {
    q: "Avez-vous un bureau permanent à Dijon ?",
    a: "Pas de bureau permanent. Déplacements réguliers et espaces partenaires centre-ville pour les RDV présentiels. Déplacements réguliers en Côte-d'Or et Bourgogne-Franche-Comté (Mâcon, Besançon sur demande).",
  },
  {
    q: "Proposez-vous des formations IA pour mes équipes bourguignonnes ?",
    a: "Oui. Ateliers de formation IA en présentiel à Dijon ou en distanciel synchrone. Formats 4h à 21h, adaptés aux équipes agroalimentaire premium, négoces de vins de Bourgogne et pharma régionale.",
  },
  {
    q: "Avez-vous une expertise négoces de vins de Bourgogne (Beaune, Nuits-Saint-Georges) ?",
    a: "Oui. Agent IA SDR multilingue (FR, EN, mandarin, japonais) pour les marchés asiatiques premium, chatbot RAG multilingue pour relations importateurs B2B internationaux, automatisation ADV export. Souveraineté France obligatoire. Secret commercial sur allocations premiers crus et grands crus garanti.",
  },
  {
    q: "Mes données restent-elles en France ?",
    a: "Oui par défaut. Mistral hébergé France (OVH, Scaleway). Critique pour les négoces de vins (secret commercial sur allocations), l'agroalimentaire premium (normes sanitaires européennes) et la pharma régionale.",
  },
  {
    q: "Avez-vous des clients en Bourgogne-Franche-Comté ?",
    a: "Oui. Négoces de vins de Bourgogne, acteurs agroalimentaires premium dijonnais, cabinets d'expertise comptable. Notre cas signature commercial export (négoce de vins, +180 % RDV importateurs asiatiques, 5 nouveaux comptes grands crus) est directement transposable au tissu négoce bourguignon.",
  },
];
    ...
    <section id="faq" style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 52 }}>
          <H2 style={{ marginBottom: 12 }}>Questions fréquentes : Althoce à Dijon et en Bourgogne-Franche-Comté</H2>
          <p style={{ fontSize: 16, color: '#52525b' }}>Réponses directes aux questions que posent nos prospects dijonnais avant la prise de contact.</p>
        </div>
        <FAQAccordion items={faqDijon} />
      </div>
    </section>
  );
}
...
function Souverainete() {
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#09090b', borderTop: '1px solid #1a1a1a' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        <div className="dij-split-rev" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'center' }}>
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .7s ease' }}>
        ...
        <H2 style={{ marginBottom: 20 }}>
          Prêt à déployer votre premier agent IA<br /><span style={{ color: AC }}>à Dijon ou en Bourgogne-Franche-Comté ?</span>
        </H2>
        <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 40, maxWidth: 520, margin: '0 auto 40px' }}>
          Un échange de 30 minutes suffit à identifier le cas d'usage le plus impactant. Repartez avec une feuille de route et un devis ferme sous 5 jours. Présentiel à Dijon ou en Côte-d'Or, ou distanciel, que l'on travaille ensemble ou non.
        </p>
...
// ── CSS ───────────────────────────────────────────────────────
const globalStyles = `
  @keyframes dij-drift { 0%,100%{transform:translate(0,0) scale(1)}50%{transform:translate(3%,4%) scale(1.06)} }
  @keyframes dij-ticker { from{transform:translateX(0)}to{transform:translateX(-50%)} }
  ...
  @media (max-width:860px) {
    .dij-hero-grid { grid-template-columns:1fr !important; }
    .dij-map-col { display:none !important; }
    .dij-split-rev { grid-template-columns:1fr !important; }
    .dij-cas-grid { grid-template-columns:1fr !important; }
    .dij-metier-row { grid-template-columns:1fr !important; }
    .dij-metier-rev > div { order:unset !important; }
    .dij-mockup-col { display:none !important; }
    .dij-grid4 { grid-template-columns:repeat(2,1fr) !important; }
  }
  @media (max-width:560px) {
    .dij-grid4 { grid-template-columns:1fr !important; }
  }
`;

export default function AgenceIADijonPageClient() {
  return (
    <main>
