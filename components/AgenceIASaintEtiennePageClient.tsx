  ...
  return (
    <section style={{ padding: '120px 24px 80px', position: 'relative', overflow: 'hidden', borderBottom: '1px solid #e4e4e7' }}>
      <div aria-hidden="true" style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
        <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: 600, height: 600, borderRadius: '50%', background: `radial-gradient(circle,${AC}0a 0%,transparent 65%)`, filter: 'blur(80px)', animation: 'ste-drift 14s ease-in-out infinite' }} />
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1160, margin: '0 auto' }}>
        <div className="ste-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            <nav aria-label="Breadcrumb" style={{ fontSize: 13, color: '#a1a1aa', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', fontWeight: 500 }}>
              ...
              <span style={{ color: '#09090b' }}>Saint-Étienne</span>
            </nav>

            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 24 }}>
              {['+150 PME équipées en France', 'Expertise sous-traitance mécanique et design', 'Présentiel + distanciel'].map((t) => (
            ...
            <h1 style={{ fontSize: 'clamp(26px,3.8vw,50px)', fontWeight: 800, lineHeight: 1.08, letterSpacing: '-.04em', color: '#09090b', marginBottom: 20 }}>
              Agence IA à Saint-Étienne : agents IA, automatisation et formation pour PME et ETI ligériennes.
            </h1>

            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 32, maxWidth: 520 }}>
              Vous dirigez une PME ou une ETI à Saint-Étienne ou dans la Loire. Althoce vous accompagne avec une expertise sur les secteurs forts régionaux (sous-traitance mécanique pour l'industrie auto et aéronautique, design via Cité du Design et French Tech, agroalimentaire régional) et une approche hybride présentiel-distanciel.
            </p>
          ...
          <div className="ste-map-col" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <FranceMapSVG mainCity="Saint-Étienne" presentielLabel="Présentiel Saint-Étienne" />
          </div>
        </div>
      </div>
    </section>
...
const raisons = [
  ...
  {
    n: '02',
    title: 'Présentiel à Saint-Étienne ET distanciel structuré',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Déplacements à Saint-Étienne (centre-ville, Manufacture Plaine Achille, ZAC technopôle), Saint-Chamond, Andrézieux-Bouthéon (zones industrielles), et plus largement dans la Loire et le Sud Auvergne-Rhône-Alpes (Roanne, Le Puy sur demande). Pour la phase de build, <strong style={{ color: '#09090b' }}>mode distanciel structuré</strong> avec points hebdomadaires de 30 minutes. Vous choisissez la modalité.
      </p>
    ),
  },
  {
    n: '03',
    title: 'Formation IA pour vos équipes ligériennes',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        <a href="/services/formation-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Ateliers de formation IA</a> en présentiel à Saint-Étienne ou en distanciel synchrone. Formats <strong style={{ color: '#09090b' }}>4h à 21h</strong>, adaptés aux équipes industrie (sous-traitance mécanique, certifications IATF/AS9100), design (cluster Cité du Design) et scale-up French Tech Saint-Étienne.
      </p>
    ),
  },
  {
    ...
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Mistral hébergé France, infrastructure auto-hébergeable, aucune donnée envoyée à OpenAI ou Anthropic sans accord client. <strong style={{ color: '#09090b' }}>Critique pour le tissu stéphanois</strong> : sous-traitance mécanique (secret industriel, compliance constructeurs IATF/AS9100), design (propriété intellectuelle créative, prototypes confidentiels), scale-up French Tech (données utilisateurs), pharma régionale. Voir <a href="/#souverainete" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Souveraineté</a>.
      </p>
    ),
  },
  {
    ...
    <section id="pourquoi" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        <div style={{ marginBottom: 52, opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s ease' }}>
          <H2 style={{ marginBottom: 16 }}>Pourquoi travailler avec Althoce pour votre projet IA à Saint-Étienne</H2>
          <p style={{ fontSize: 16, color: '#52525b', lineHeight: 1.7, maxWidth: 640 }}>
            Cinq raisons concrètes qui nous distinguent des autres prestataires IA dans la Loire.
          </p>
        </div>
        ...
        <div style={{ marginTop: 48, borderRadius: 20, background: '#09090b', border: '1px solid #1e1e1e', overflow: 'hidden', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s .5s ease' }}>
          ...
          <div style={{ padding: '24px 28px' }}>
            <p style={{ fontSize: 16, color: '#a1a1aa', lineHeight: 1.8, margin: '0 0 16px' }}>
              <strong style={{ color: '#e4e4e7' }}>Mêmes délais, même qualité quel que soit le mode.</strong> Présentiel pertinent pour le cadrage à Saint-Étienne (Manufacture Plaine Achille, centre-ville), Saint-Chamond ou Andrézieux-Bouthéon. Distanciel pour le build (60 à 70 % du projet) gagne du temps à tout le monde.
            </p>
...
function MetierMockup({ index }: { index: number }) {
  const mockups = [
    // Ops — ETI industrielles ligériennes
    <div style={{ background: '#09090b', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.18)', border: `1px solid ${AC}30` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        <span style={{ fontSize: 12, fontWeight: 800, color: '#3f3f46', textTransform: 'uppercase', letterSpacing: '.1em' }}>ETI mécanique · Loire</span>
      ...
      {[{ l: 'Mails ADV absorbés', v: '×3' }, { l: 'Commandes traitées auto.', v: '100 %' }, { l: 'Turnover ops', v: 'Stoppé' }, { l: 'Délai déploiement', v: '6 sem.' }].map((r, i) => (
    ...
    // Achats — sous-traitance mécanique, certifications
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>Sous-traitant auto · Saint-Étienne</div>
      {[{ l: 'Sourcing fournisseur', v: '×6 rapide' }, { l: 'Économies achats', v: '1,2 M€' }, { l: 'Conformité IATF', v: '100 %' }, { l: 'Ruptures surprises', v: '0' }].map((r, i) => (
    ...
    // Finance — cabinets pro stéphanois
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>Cabinet expertise comptable · Loire</div>
      {[{ l: 'Capacité cabinet', v: '×2' }, { l: 'Saisie automatisée', v: '80 %' }, { l: 'Délai clôture', v: '−4 jours' }, { l: 'Souveraineté Mistral', v: '100 % FR' }].map((r, i) => (
        <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '9px 0', borderBottom: i < 3 ? '1px solid #f4f4f5' : 'none' }}>
          <span style={{ fontSize: 13, color: '#52525b', fontWeight: 500 }}>{r.l}</span>
          <span style={{ fontSize: 14, fontWeight: 800, color: AC }}>{r.v}</span>
        </div>
    ...
    // Marketing — design, French Tech
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 10 }}>Scale-up French Tech · Saint-Étienne</div>
      {[{ l: 'Contenu produit', v: '×4' }, { l: 'Trafic organique', v: '+140 %' }, { l: 'Économies annuelles', v: '60k€' }, { l: 'Déploiement', v: '3 sem.' }].map((r, i) => (
        <div key={i} style={{ marginBottom: 10 }}>
          ...
          <div style={{ height: 4, background: '#f4f4f5', borderRadius: 9999, overflow: 'hidden' }}>
            <div style={{ height: '100%', width: `${[100, 100, 90, 85][i]}%`, background: `linear-gradient(to right,${AC},${AC}88)`, borderRadius: 9999 }} />
          </div>
        </div>
      ))}
    </div>,
...
const metiers = [
  {
    n: '01', href: '/agent-ia/ops/', label: 'Opérations et back-office (ETI industrielles ligériennes)', tag: 'Agent IA Opérations →',
    desc: "Les ETI industrielles stéphanoises (sous-traitance mécanique pour PSA Stellantis, Renault, équipementiers automobiles, sous-traitance aéronautique vers Toulouse, fournisseurs ferroviaires Alstom) gèrent des flux ADV complexes avec grands donneurs d'ordre. Notre agent IA absorbe la couche répétitive : traitement commandes, relances, classement documents. Cas signature : distributeur B2B, mails ×3 absorbés, ADV automatisée, fin du turnover ops.",
    pub: "ETI sous-traitance mécanique Loire · Équipementiers auto Saint-Étienne · Fournisseurs Alstom et Stellantis · Sous-traitants aéro",
    reverse: false,
  },
  {
    n: '02', href: '/agent-ia/achats/', label: 'Achats (sous-traitance mécanique, certifications industrie)', tag: 'Agent IA Achats →',
    desc: "Les directions achats des ETI sous-traitantes mécaniques gèrent des panels fournisseurs avec exigences fortes (certifications IATF 16949 pour l'auto, AS9100/EN9100 pour l'aéro, vigilance financière sous-traitants critiques). Notre agent IA combine sourcing accéléré, analyse de devis pondérés par certification et surveillance financière continue des fournisseurs. Cas signature : ETI industrielle, +4 % d'économies achats = 1,2 M€.",
    pub: "ETI mécanique sous-traitance auto · Fournisseurs IATF Loire · Sous-traitants aéro AS9100 · Industries ferroviaires ligériennes",
    reverse: true,
  },
  {
    n: '03', href: '/agent-ia/finance/', label: 'Finance et comptabilité (cabinets pro stéphanois)', tag: 'Agent IA Finance →',
    desc: "Les cabinets d'expertise comptable stéphanois et les directions financières d'ETI ligériennes absorbent 60 à 80 % de saisie répétitive (factures fournisseurs, rapprochements bancaires, préparation de bilans). Notre agent IA finance prend en charge la saisie et la classification automatique, laissant les experts-comptables se concentrer sur le conseil et la relation client. Cas signature : cabinet d'expertise comptable lyonnais, ×2 capacité en 4 mois.",
    pub: "Cabinets d'expertise comptable stéphanois · Directions financières ETI Loire · Cabinets d'audit Auvergne-Rhône-Alpes",
    reverse: false,
  },
  {
    n: '04', href: '/agent-ia/marketing/', label: 'Marketing et content (design, French Tech Saint-Étienne)', tag: 'Agent IA Marketing →',
    desc: "Les agences de design stéphanoises (cluster Cité du Design, Manufacture Plaine Achille) et les scale-up French Tech Saint-Étienne doivent produire un contenu créatif au ton de marque sans diluer leur identité. Notre agent IA marketing génère articles SEO, social media et newsletters en s'adaptant au positionnement créatif de chaque marque. Cas type : éditeur SaaS B2B, content ×4 sans embauche, trafic +140 %.",
    pub: "Agences design Cité du Design · Scale-up French Tech Saint-Étienne · Studios créatifs Manufacture Plaine Achille · PME tech Loire",
    reverse: true,
  },
];

function MetiersSaintEtienne() {
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto' }}>
        <div style={{ marginBottom: 56 }}>
          <H2 style={{ marginBottom: 12 }}>L'IA transforme chaque métier stéphanois</H2>
          <p style={{ fontSize: 16, color: '#52525b', maxWidth: 640, lineHeight: 1.7 }}>
            Quatre métiers où nos agents IA ont déjà transformé le quotidien de PME et ETI ligériennes, des sous-traitants mécaniques à la Cité du Design. Pour la liste complète, voir notre <a href="/agent-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>hub agents IA par fonction</a>.
          </p>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 56 }}>
          {metiers.map((m, i) => (
            <div key={i} className={`ste-metier-row${m.reverse ? ' ste-metier-rev' : ''}`}
              ...
              <div style={{ order: m.reverse ? 2 : 1 }}>
                ...
                <div style={{ padding: '10px 16px', borderRadius: 10, background: '#f0f7ff', border: `1px solid ${AC}15`, marginBottom: 20 }}>
                  <div style={{ fontSize: 10, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 4 }}>Public type Saint-Étienne / Loire</div>
              ...
              <div className="ste-mockup-col" style={{ order: m.reverse ? 1 : 2 }}>
        ...
        <div style={{ marginTop: 64, overflow: 'hidden', borderTop: '1px solid #e4e4e7', paddingTop: 32 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', gap: 10, animation: 'ste-ticker 60s linear infinite', width: 'max-content' }}>
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .6s ease' }}>
        <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.14em', marginBottom: 24 }}>Cas client Loire · Anonymisé</div>
        <H2 style={{ marginBottom: 20 }}>ETI sous-traitance mécanique ligérienne : ADV et achats automatisés en 6 semaines</H2>

        <div style={{ display: 'inline-flex', flexWrap: 'wrap', gap: 6, marginBottom: 40, padding: '6px 14px', borderRadius: 9999, background: '#f4f4f5' }}>
          {['ETI sous-traitance mécanique', '150 collaborateurs', 'Loire', '2025-2026', 'cas anonymisé'].map((t) => (
        ...
        <div className="ste-cas-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.8fr', gap: 48, alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { v: '×6', l: 'sourcing fournisseurs plus rapide', hero: true },
              { v: '50 %', l: 'temps libéré pour les acheteurs', hero: false },
              { v: '100 %', l: 'conformité IATF documentée en continu', hero: false },
          ...
          <div>
            <h3 style={{ fontSize: 18, fontWeight: 800, color: '#09090b', marginBottom: 16, lineHeight: 1.3 }}>150 collaborateurs, 2 donneurs d'ordre majeurs (Renault et Alstom), compliance IATF non-négociable.</h3>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 20 }}>
              L'ETI sous-traitante mécanique fournit des composants pour Renault, PSA Stellantis et Alstom. La compliance constructeurs est stricte (IATF 16949 pour l'automobile, documentation qualité exigée à chaque livraison). Les acheteurs passaient 70 % de leur temps sur du sourcing répétitif et la vérification de certifications, au détriment de la négociation stratégique. La souveraineté France était non-négociable : secret industriel et plans techniques confidentiels.
            </p>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 28 }}>
              2 agents IA Althoce déployés en 6 semaines (cadrage présentiel à Saint-Étienne, build distanciel avec hébergement Mistral OVH France) : un agent ADV pour les commandes récurrentes, un agent sourcing-achats avec veille financière fournisseurs. Aujourd'hui, les acheteurs ont libéré 50 % de leur temps pour la négociation avec les constructeurs. L'ADV tourne en autonomie sur les commandes récurrentes.
            </p>
            ...
            <div style={{ padding: '20px 24px', borderRadius: 14, background: '#f0f7ff', border: `1px solid ${AC}20`, marginBottom: 24 }}>
              <p style={{ fontSize: 15, color: '#1e3a5f', lineHeight: 1.75, margin: 0, fontStyle: 'italic' }}>
                "Le sourcing qui prenait une semaine prend maintenant quelques heures. Et les données n'ont jamais quitté la France. C'était notre condition sine qua non."
              </p>
              <div style={{ marginTop: 10, fontSize: 13, fontWeight: 700, color: '#52525b' }}>Directeur achats · ETI sous-traitance mécanique ligérienne</div>
            </div>

            <a href="/cas-clients/eti-industrielle-agent-ia-achats/" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 700, color: AC, textDecoration: 'none', padding: '10px 20px', border: `1px solid ${AC}30`, borderRadius: 9999, transition: 'all .15s' }}
              onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.background = `${AC}08`; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.background = 'transparent'; }}>
              Lire le cas signature achats →
            </a>
          </div>
        </div>
      </div>
  ...
  return (
    <section id="method" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div className="ste-grid4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24 }}>
          {steps.map((s, i) => (
...
// ── FAQ ───────────────────────────────────────────────────────
const faqSaintEtienne = [
  {
    q: "Présentiel à Saint-Étienne ou distanciel : quelle différence ?",
    a: "Aucune différence qualité ni délais. Présentiel à Saint-Étienne (Manufacture Plaine Achille, centre-ville), Saint-Chamond, Andrézieux-Bouthéon, ou dans la Loire plus largement pour le cadrage et les ateliers. Build en distanciel structuré avec points hebdomadaires de 30 minutes.",
  },
  {
    q: "Avez-vous un bureau permanent à Saint-Étienne ?",
    a: "Pas de bureau permanent. Déplacements réguliers et espaces partenaires à la Manufacture Plaine Achille pour les RDV présentiels. Déplacements réguliers dans la Loire et le Sud Auvergne-Rhône-Alpes (Roanne, Le Puy-en-Velay sur demande).",
  },
  {
    q: "Proposez-vous des formations IA pour mes équipes ligériennes ?",
    a: "Oui. Ateliers de formation IA en présentiel à Saint-Étienne ou en distanciel synchrone. Formats 4h à 21h, adaptés aux métiers industrie sous-traitance (IATF, AS9100) et aux équipes design et scale-up French Tech.",
  },
  {
    q: "Avez-vous une expertise sur la sous-traitance industrie auto (IATF) et aéro (AS9100) ?",
    a: "Oui. Cas types : automatisation ADV grands donneurs d'ordre (Renault, PSA Stellantis, Alstom), documentation conformité IATF 16949 et AS9100/EN9100, vigilance financière fournisseurs critiques, gestion documentaire qualité. Données hébergées Mistral OVH France. Secret industriel garanti.",
  },
  {
    q: "Mes données restent-elles en France ?",
    a: "Oui par défaut. Mistral hébergé France (OVH, Scaleway). Critique pour le secret industriel mécanique (plans, tolérances, conditions constructeurs), le design (propriété intellectuelle créative, prototypes confidentiels) et les scale-up French Tech (données utilisateurs).",
  },
  {
    q: "Avez-vous des clients à Saint-Étienne et dans la Loire ?",
    a: "Oui. ETI sous-traitance mécanique ligériennes, cabinets d'expertise comptable stéphanois, scale-up French Tech Saint-Étienne. Notre cas signature ETI industrielle (sourcing ×6, 50 % temps libéré pour les acheteurs, compliance IATF documentée) est directement transposable au tissu sous-traitance mécanique régional.",
  },
];

function FAQSaintEtienne() {
  return (
    <section id="faq" style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 52 }}>
          <H2 style={{ marginBottom: 12 }}>Questions fréquentes : Althoce à Saint-Étienne et dans la Loire</H2>
          <p style={{ fontSize: 16, color: '#52525b' }}>Réponses directes aux questions que posent nos prospects stéphanois avant la prise de contact.</p>
        </div>
        <FAQAccordion items={faqSaintEtienne} />
      </div>
    </section>
  );
}
...
function Souverainete() {
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#09090b', borderTop: '1px solid #1a1a1a' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        <div className="ste-split-rev" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'center' }}>
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .7s ease' }}>
        ...
        <H2 style={{ marginBottom: 20 }}>
          Prêt à déployer votre premier agent IA<br /><span style={{ color: AC }}>à Saint-Étienne ou dans la Loire ?</span>
        </H2>
        <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 40, maxWidth: 520, margin: '0 auto 40px' }}>
          Un échange de 30 minutes suffit à identifier le cas d'usage le plus impactant. Repartez avec une feuille de route et un devis ferme sous 5 jours. Présentiel à Saint-Étienne ou dans la Loire, ou distanciel, que l'on travaille ensemble ou non.
        </p>
...
// ── CSS ───────────────────────────────────────────────────────
const globalStyles = `
  @keyframes ste-drift { 0%,100%{transform:translate(0,0) scale(1)}50%{transform:translate(3%,4%) scale(1.06)} }
  @keyframes ste-ticker { from{transform:translateX(0)}to{transform:translateX(-50%)} }
  ...
  @media (max-width:860px) {
    .ste-hero-grid { grid-template-columns:1fr !important; }
    .ste-map-col { display:none !important; }
    .ste-split-rev { grid-template-columns:1fr !important; }
    .ste-cas-grid { grid-template-columns:1fr !important; }
    .ste-metier-row { grid-template-columns:1fr !important; }
    .ste-metier-rev > div { order:unset !important; }
    .ste-mockup-col { display:none !important; }
    .ste-grid4 { grid-template-columns:repeat(2,1fr) !important; }
  }
  @media (max-width:560px) {
    .ste-grid4 { grid-template-columns:1fr !important; }
  }
`;

export default function AgenceIASaintEtiennePageClient() {
  return (
    <main>
