  ...
  return (
    <section style={{ padding: '120px 24px 80px', position: 'relative', overflow: 'hidden', borderBottom: '1px solid #e4e4e7' }}>
      <div aria-hidden="true" style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
        <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: 600, height: 600, borderRadius: '50%', background: `radial-gradient(circle,${AC}0a 0%,transparent 65%)`, filter: 'blur(80px)', animation: 'grn-drift 14s ease-in-out infinite' }} />
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1160, margin: '0 auto' }}>
        <div className="grn-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            <nav aria-label="Breadcrumb" style={{ fontSize: 13, color: '#a1a1aa', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', fontWeight: 500 }}>
              ...
              <span style={{ color: '#09090b' }}>Grenoble</span>
            </nav>

            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 24 }}>
              {['+150 PME équipées en France', 'Expertise deep tech et micro-électronique', 'Présentiel + distanciel'].map((t) => (
            ...
            <h1 style={{ fontSize: 'clamp(26px,3.8vw,50px)', fontWeight: 800, lineHeight: 1.08, letterSpacing: '-.04em', color: '#09090b', marginBottom: 20 }}>
              Agence IA à Grenoble : agents IA, automatisation et formation pour PME et ETI grenobloises.
            </h1>

            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 32, maxWidth: 520 }}>
              Vous dirigez une PME ou une ETI à Grenoble, dans la Métropole ou en Isère. Althoce vous accompagne avec une expertise sur les secteurs forts régionaux (scale-up deep tech d'Inovallée, micro-électronique STMicroelectronics et Soitec, recherche CEA-Leti et CNRS, énergie Schneider Electric) et une approche hybride présentiel-distanciel.
            </p>
          ...
          <div className="grn-map-col" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <FranceMapSVG mainCity="Grenoble" presentielLabel="Présentiel Grenoble" />
          </div>
        </div>
      </div>
    </section>
...
const raisons = [
  ...
  {
    n: '02',
    title: 'Présentiel à Grenoble ET distanciel structuré',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Déplacements à Grenoble (centre-ville, Polygone scientifique, Europole), à Meylan (Inovallée), à Crolles (STMicroelectronics), à Échirolles, et plus largement en Isère (Voiron, Bourgoin-Jallieu) et dans les Alpes (Chambéry, Annecy sur demande). Pour la phase de build, <strong style={{ color: '#09090b' }}>mode distanciel structuré</strong> avec points hebdomadaires de 30 minutes. Vous choisissez la modalité.
      </p>
    ),
  },
  {
    n: '03',
    title: 'Formation IA pour vos équipes grenobloises',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        <a href="/services/formation-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Ateliers de formation IA</a> en présentiel à Grenoble ou en distanciel synchrone. Formats <strong style={{ color: '#09090b' }}>4h à 21h</strong>, adaptés aux équipes scale-up deep tech, micro-électronique (compliance constructeurs, certifications fab) et R&D pharma grenobloise.
      </p>
    ),
  },
  {
    ...
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Mistral hébergé France, infrastructure auto-hébergeable, aucune donnée envoyée à OpenAI ou Anthropic sans accord client. <strong style={{ color: '#09090b' }}>Critique pour le tissu grenoblois</strong> : micro-électronique (STMicroelectronics Crolles, Soitec : secret industriel, propriété intellectuelle), deep tech Inovallée (scale-up B2B, IoT, hardware, brevets), recherche CEA-Leti / CNRS (recherche fondamentale), énergie Schneider Electric (secret commercial). Voir <a href="/#souverainete" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Souveraineté</a>.
      </p>
    ),
  },
  {
    ...
    <section id="pourquoi" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        <div style={{ marginBottom: 52, opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s ease' }}>
          <H2 style={{ marginBottom: 16 }}>Pourquoi travailler avec Althoce pour votre projet IA à Grenoble</H2>
          <p style={{ fontSize: 16, color: '#52525b', lineHeight: 1.7, maxWidth: 640 }}>
            Cinq raisons concrètes qui nous distinguent des autres prestataires IA en Isère.
          </p>
        </div>
        ...
        <div style={{ marginTop: 48, borderRadius: 20, background: '#09090b', border: '1px solid #1e1e1e', overflow: 'hidden', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s .5s ease' }}>
          ...
          <div style={{ padding: '24px 28px' }}>
            <p style={{ fontSize: 16, color: '#a1a1aa', lineHeight: 1.8, margin: '0 0 16px' }}>
              <strong style={{ color: '#e4e4e7' }}>Mêmes délais, même qualité quel que soit le mode.</strong> Présentiel pertinent pour le cadrage à Grenoble (Polygone scientifique, Europole) ou Meylan (Inovallée). Distanciel pour le build (60 à 70 % du projet) gagne du temps à tout le monde.
            </p>
...
function MetierMockup({ index }: { index: number }) {
  const mockups = [
    // Service client — SaaS deep tech Inovallée
    <div style={{ background: '#09090b', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.18)', border: `1px solid ${AC}30` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        <span style={{ fontSize: 12, fontWeight: 800, color: '#3f3f46', textTransform: 'uppercase', letterSpacing: '.1em' }}>Scale-up deep tech · Inovallée</span>
      ...
      {[{ l: 'N1 technique absorbé', v: '70 %' }, { l: 'CSAT', v: '+12 pts' }, { l: 'Embauches annulées', v: '3 (180k€)' }, { l: 'Déploiement', v: '5 sem.' }].map((r, i) => (
    ...
    // Achats — micro-électronique, certifications
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>ETI micro-électronique · Crolles</div>
      {[{ l: 'Sourcing composants', v: '×6 rapide' }, { l: 'Économies achats', v: '1,2 M€' }, { l: 'Ruptures surprises', v: '0' }, { l: 'Conformité ISO', v: '100 %' }].map((r, i) => (
    ...
    // Marketing — scale-up tech, B2B
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>SaaS B2B deep tech · Grenoble</div>
    ...
    // RH — recrutement profils tech
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 10 }}>Scale-up tech · Inovallée Meylan</div>
      {[{ l: 'Volume CV triés', v: '×3,5' }, { l: 'Biais éliminés', v: '100 %' }, { l: 'Temps RH libéré', v: '60 %' }, { l: 'Profils qualifiés/sem.', v: '+45 %' }].map((r, i) => (
        <div key={i} style={{ marginBottom: 10 }}>
          ...
          <div style={{ height: 4, background: '#f4f4f5', borderRadius: 9999, overflow: 'hidden' }}>
            <div style={{ height: '100%', width: `${[95, 100, 85, 90][i]}%`, background: `linear-gradient(to right,${AC},${AC}88)`, borderRadius: 9999 }} />
          </div>
        </div>
      ))}
    </div>,
...
const metiers = [
  {
    n: '01', href: '/agent-ia/service-client/', label: 'Service client (SaaS deep tech, scale-up Inovallée)', tag: 'Agent IA Service client →',
    desc: "Les scale-up deep tech d'Inovallée (IoT industriel, hardware, SaaS B2B, plateformes) ont une clientèle internationale technique (intégrateurs, OEM, distributeurs). Notre chatbot IA RAG multilingue absorbe 70 % du N1 en 9 langues, intégré aux bases de connaissances techniques (docs produit, guides d'intégration, troubleshooting). L'équipe humaine se concentre sur les intégrations complexes et la relation OEM stratégique. Cas signature : éditeur SaaS B2B, CSAT +12 points, 3 embauches annulées.",
    pub: "Scale-up IoT industriel Inovallée · SaaS B2B deep tech Grenoble · Plateformes hardware Meylan · Startups tech Isère",
    reverse: false,
  },
  {
    n: '02', href: '/agent-ia/achats/', label: 'Achats (micro-électronique, certifications industrie)', tag: 'Agent IA Achats →',
    desc: "Les directions achats des ETI micro-électronique grenobloises (STMicroelectronics Crolles, Soitec, sous-traitants fab) gèrent des panels fournisseurs avec exigences extrêmes (qualité fab semi-conducteurs, conformité ISO, vigilance financière critique sur composants stratégiques). Notre agent IA combine sourcing accéléré, analyse devis pondérée par certification et surveillance financière continue. Souveraineté France obligatoire (secret industriel, propriété intellectuelle). Cas signature : ETI industrielle, +4 % d'économies = 1,2 M€.",
    pub: "ETI micro-électronique Crolles · Sous-traitants STMicroelectronics · Fournisseurs fab semi-conducteurs · Industries Isère",
    reverse: true,
  },
  {
    n: '03', href: '/agent-ia/marketing/', label: 'Marketing et content (scale-up tech, agences B2B)', tag: 'Agent IA Marketing →',
    desc: "Les scale-up tech grenobloises et les agences B2B spécialisées deep tech doivent produire un contenu technique au ton de marque (whitepapers, articles techniques, séquences nurture B2B, posts LinkedIn). Notre agent IA marketing génère un contenu en cohérence brand, adapté à l'audience ingénieure et décideur tech. Cas type : éditeur SaaS B2B, content ×4 sans embauche, trafic organique +140 %.",
    pub: "Scale-up SaaS B2B Grenoble · Agences marketing tech Isère · Startups deep tech Inovallée · PME tech Auvergne-Rhône-Alpes",
    reverse: false,
  },
  {
    n: '04', href: '/agent-ia/rh/', label: 'RH (recrutement profils tech, ingénieurs, chercheurs)', tag: 'Agent IA RH →',
    desc: "Grenoble est l'un des bassins tech les plus compétitifs de France : ingénieurs micro-électronique, développeurs deep tech, chercheurs, data scientists. Les DRH de scale-up et ETI grenobloises et les cabinets de recrutement spécialisés tech reçoivent des volumes de CV importants sur des profils rares. Notre agent IA tri CV anti-biais documenté pré-qualifie en quelques minutes. Cas signature : cabinet de recrutement Paris (transposable Grenoble), ×3,5 volume CV triés.",
    pub: "DRH scale-up Inovallée · Cabinets recrutement tech Grenoble · ETI micro-électronique Crolles · Startups deep tech Isère",
    reverse: true,
  },
];

function MetiersGrenoble() {
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto' }}>
        <div style={{ marginBottom: 56 }}>
          <H2 style={{ marginBottom: 12 }}>L'IA transforme chaque métier grenoblois</H2>
          <p style={{ fontSize: 16, color: '#52525b', maxWidth: 640, lineHeight: 1.7 }}>
            Quatre métiers où nos agents IA ont déjà transformé le quotidien de PME et ETI grenobloises, des scale-up Inovallée aux ETI micro-électronique de Crolles. Pour la liste complète, voir notre <a href="/agent-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>hub agents IA par fonction</a>.
          </p>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 56 }}>
          {metiers.map((m, i) => (
            <div key={i} className={`grn-metier-row${m.reverse ? ' grn-metier-rev' : ''}`}
              ...
              <div style={{ order: m.reverse ? 2 : 1 }}>
                ...
                <div style={{ padding: '10px 16px', borderRadius: 10, background: '#f0f7ff', border: `1px solid ${AC}15`, marginBottom: 20 }}>
                  <div style={{ fontSize: 10, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 4 }}>Public type Grenoble / Isère</div>
              ...
              <div className="grn-mockup-col" style={{ order: m.reverse ? 1 : 2 }}>
        ...
        <div style={{ marginTop: 64, overflow: 'hidden', borderTop: '1px solid #e4e4e7', paddingTop: 32 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', gap: 10, animation: 'grn-ticker 60s linear infinite', width: 'max-content' }}>
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .6s ease' }}>
        <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.14em', marginBottom: 24 }}>Cas client Isère · Anonymisé</div>
        <H2 style={{ marginBottom: 20 }}>Scale-up deep tech Inovallée : 70 % du support technique N1 absorbé en 5 semaines</H2>

        <div style={{ display: 'inline-flex', flexWrap: 'wrap', gap: 6, marginBottom: 40, padding: '6px 14px', borderRadius: 9999, background: '#f4f4f5' }}>
          {['Scale-up deep tech (IoT industriel)', '110 collaborateurs', 'Inovallée Meylan', '2025-2026', 'cas anonymisé'].map((t) => (
        ...
        <div className="grn-cas-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.8fr', gap: 48, alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { v: '70 %', l: 'du N1 technique absorbé en autonomie', hero: true },
              { v: '+12 pts', l: 'CSAT après déploiement', hero: false },
              { v: '0', l: 'départ équipe support tech', hero: false },
              { v: '180k€/an', l: 'économisés (3 embauches annulées)', hero: false },
            ].map((kpi, i) => (
          ...
          <div>
            <h3 style={{ fontSize: 18, fontWeight: 800, color: '#09090b', marginBottom: 16, lineHeight: 1.3 }}>110 collaborateurs, clients OEM en France, Allemagne et UK. Support technique B2B saturé sur une documentation riche mais inexploitable directement.</h3>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 20 }}>
              La scale-up deep tech grenobloise vend des solutions IoT industrielles à des clients OEM exigeants. Le support technique B2B était saturé : questions complexes sur intégrations, paramétrages, troubleshooting. La documentation technique était riche mais peu exploitable directement par les clients sans accompagnement humain. L'équipe support, déjà débordée, perdait des heures sur des questions répétitives pouvant être répondues par la doc.
            </p>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 28 }}>
              Agent IA Althoce intégré à Zendesk et à la base de connaissances technique déployé en 5 semaines (cadrage présentiel à Inovallée, build distanciel, hébergement Mistral OVH France). Aujourd'hui, 70 % des questions techniques standards sont traitées en autonomie. L'équipe humaine se concentre sur les intégrations complexes et la relation OEM stratégique. Les 3 embauches prévues ont été annulées.
            </p>
            ...
            <div style={{ padding: '20px 24px', borderRadius: 14, background: '#f0f7ff', border: `1px solid ${AC}20`, marginBottom: 24 }}>
              <p style={{ fontSize: 15, color: '#1e3a5f', lineHeight: 1.75, margin: 0, fontStyle: 'italic' }}>
                "Nos ingénieurs ne répondent plus aux mêmes questions trois fois par semaine. L'agent connaît la doc mieux que certains nouveaux arrivants. Et CSAT a pris +12 points en 2 mois."
              </p>
              <div style={{ marginTop: 10, fontSize: 13, fontWeight: 700, color: '#52525b' }}>Head of Customer Success · Scale-up IoT industriel, Inovallée Meylan</div>
            </div>
  ...
  return (
    <section id="method" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div className="grn-grid4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24 }}>
          {steps.map((s, i) => (
...
const faqGrenoble = [
  {
    q: "Présentiel à Grenoble ou distanciel : quelle différence ?",
    a: "Aucune différence qualité ni délais. Présentiel à Grenoble (centre-ville, Polygone scientifique, Europole), Meylan (Inovallée), Crolles (STMicroelectronics) ou Échirolles pour le cadrage et les ateliers. Build en distanciel structuré avec points hebdomadaires de 30 minutes.",
  },
  {
    q: "Avez-vous un bureau permanent à Grenoble ?",
    a: "Pas de bureau permanent. Déplacements réguliers et espaces partenaires à Inovallée pour les RDV présentiels. Déplacements réguliers en Isère et dans les Alpes (Chambéry, Annecy sur demande).",
  },
  {
    q: "Proposez-vous des formations IA pour mes équipes grenobloises ?",
    a: "Oui. Ateliers de formation IA en présentiel à Grenoble ou en distanciel synchrone. Formats 4h à 21h, adaptés aux équipes scale-up deep tech, micro-électronique (compliance fab) et R&D pharma.",
  },
  {
    q: "Avez-vous une expertise micro-électronique (STMicroelectronics, Soitec) ?",
    a: "Oui. Sous-traitance micro-électronique, conformité industrie semi-conducteurs, vigilance fournisseurs critiques (rupture composants), gestion documentaire qualité fab. Souveraineté Mistral France obligatoire. Secret industriel et propriété intellectuelle garantis.",
  },
  {
    q: "La souveraineté France est-elle garantie pour le deep tech et la R&D ?",
    a: "Oui par défaut. Mistral hébergé France (OVH, Scaleway). Critique pour la propriété intellectuelle des scale-up deep tech Inovallée, les brevets, le secret industriel micro-électronique et la recherche CEA-Leti / CNRS.",
  },
  {
    q: "Avez-vous des clients à Grenoble et en Isère ?",
    a: "Oui. Scale-up Inovallée, ETI micro-électronique Crolles, cabinets pro grenoblois. Notre cas signature service client (70 % N1 absorbé, CSAT +12 pts, 3 embauches annulées) est directement transposable au tissu deep tech régional.",
  },
];

function FAQGrenoble() {
  return (
    <section id="faq" style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 52 }}>
          <H2 style={{ marginBottom: 12 }}>Questions fréquentes : Althoce à Grenoble et en Isère</H2>
          <p style={{ fontSize: 16, color: '#52525b' }}>Réponses directes aux questions que posent nos prospects grenoblois avant la prise de contact.</p>
        </div>
        <FAQAccordion items={faqGrenoble} />
      </div>
    </section>
  );
}
...
function Souverainete() {
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#09090b', borderTop: '1px solid #1a1a1a' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        <div className="grn-split-rev" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'center' }}>
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .7s ease' }}>
        ...
        <H2 style={{ marginBottom: 20 }}>
          Prêt à déployer votre premier agent IA<br /><span style={{ color: AC }}>à Grenoble ou en Isère ?</span>
        </H2>
        <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 40, maxWidth: 520, margin: '0 auto 40px' }}>
          Un échange de 30 minutes suffit à identifier le cas d'usage le plus impactant. Repartez avec une feuille de route et un devis ferme sous 5 jours. Présentiel à Grenoble ou en Isère, ou distanciel, que l'on travaille ensemble ou non.
        </p>
...
// ── CSS ───────────────────────────────────────────────────────
const globalStyles = `
  @keyframes grn-drift { 0%,100%{transform:translate(0,0) scale(1)}50%{transform:translate(3%,4%) scale(1.06)} }
  @keyframes grn-ticker { from{transform:translateX(0)}to{transform:translateX(-50%)} }
  ...
  @media (max-width:860px) {
    .grn-hero-grid { grid-template-columns:1fr !important; }
    .grn-map-col { display:none !important; }
    .grn-split-rev { grid-template-columns:1fr !important; }
    .grn-cas-grid { grid-template-columns:1fr !important; }
    .grn-metier-row { grid-template-columns:1fr !important; }
    .grn-metier-rev > div { order:unset !important; }
    .grn-mockup-col { display:none !important; }
    .grn-grid4 { grid-template-columns:repeat(2,1fr) !important; }
  }
  @media (max-width:560px) {
    .grn-grid4 { grid-template-columns:1fr !important; }
  }
`;

export default function AgenceIAGrenoblePageClient() {
  return (
    <main>
