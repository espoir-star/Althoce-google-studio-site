  ...
  return (
    <section style={{ padding: '120px 24px 80px', position: 'relative', overflow: 'hidden', borderBottom: '1px solid #e4e4e7' }}>
      <div aria-hidden="true" style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
        <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: 600, height: 600, borderRadius: '50%', background: `radial-gradient(circle,${AC}0a 0%,transparent 65%)`, filter: 'blur(80px)', animation: 'mpl-drift 14s ease-in-out infinite' }} />
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1160, margin: '0 auto' }}>
        <div className="mpl-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            <nav aria-label="Breadcrumb" style={{ fontSize: 13, color: '#a1a1aa', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', fontWeight: 500 }}>
              ...
              <span style={{ color: '#09090b' }}>Montpellier</span>
            </nav>

            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 24 }}>
              {['+150 PME équipées en France', 'Expertise santé et FrenchTech', 'Présentiel + distanciel'].map((t) => (
            ...
            <h1 style={{ fontSize: 'clamp(26px,3.8vw,50px)', fontWeight: 800, lineHeight: 1.08, letterSpacing: '-.04em', color: '#09090b', marginBottom: 20 }}>
              Agence IA à Montpellier : agents IA, automatisation et formation pour PME et ETI montpelliéraines.
            </h1>

            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 32, maxWidth: 520 }}>
              Vous dirigez une PME ou une ETI à Montpellier ou en Occitanie côté Méditerranée. Althoce vous accompagne avec une expertise sur les secteurs forts régionaux (santé et biotech, numérique FrenchTech Méditerranée, viticulture Languedoc, agroalimentaire) et une approche hybride présentiel-distanciel.
            </p>
          ...
          <div className="mpl-map-col" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <FranceMapSVG mainCity="Montpellier" presentielLabel="Présentiel Montpellier" />
          </div>
        </div>
      </div>
    </section>
...
const raisons = [
  ...
  {
    n: '02',
    title: 'Présentiel à Montpellier ET distanciel structuré',
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Pour les phases stratégiques (cadrage, ateliers, COMEX), nous nous déplaçons régulièrement à Montpellier (Antigone, Comédie, Port Marianne, Millénaire), au technopôle Cap Alpha, à Pérols-Lattes, et plus largement en Occitanie côté Méditerranée (Nîmes, Béziers, Sète sur demande). Pour la phase de build, <strong style={{ color: '#09090b' }}>mode distanciel structuré</strong> avec points hebdomadaires de 30 minutes. Vous choisissez la modalité.
      </p>
    ),
  },
  {
    ...
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        <a href="/services/formation-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Ateliers de formation IA</a> en présentiel dans vos locaux à Montpellier ou Cap Alpha, ou en distanciel synchrone. Formats <strong style={{ color: '#09090b' }}>4h à 21h</strong>, adaptés par métier. Particulièrement utiles pour les équipes biotech (compliance HAS, ANSM, EMA), les scale-up FrenchTech Méditerranée et les agences digitales.
      </p>
    ),
  },
  {
    ...
    body: (
      <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.8, margin: 0 }}>
        Mistral hébergé France, infrastructure auto-hébergeable, aucune donnée envoyée à OpenAI ou Anthropic sans accord client. <strong style={{ color: '#09090b' }}>Critique pour le tissu montpelliérain</strong> : santé et biotech (CHU Montpellier, Institut Méditerranéen de Cancérologie, données patients), scale-up FrenchTech Méditerranée (données utilisateurs SaaS), viticulture Languedoc premium (secret commercial). Voir <a href="/#souverainete" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>Souveraineté</a>.
      </p>
    ),
  },
  {
    ...
    <section id="pourquoi" ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        <div style={{ marginBottom: 52, opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s ease' }}>
          <H2 style={{ marginBottom: 16 }}>Pourquoi travailler avec Althoce pour votre projet IA à Montpellier</H2>
          <p style={{ fontSize: 16, color: '#52525b', lineHeight: 1.7, maxWidth: 640 }}>
            Cinq raisons concrètes qui nous distinguent des autres prestataires IA en Occitanie et en Méditerranée.
          </p>
        </div>
        ...
        <div style={{ marginTop: 48, borderRadius: 20, background: '#09090b', border: '1px solid #1e1e1e', overflow: 'hidden', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(16px)', transition: 'all .5s .5s ease' }}>
          ...
          <div style={{ padding: '24px 28px' }}>
            <p style={{ fontSize: 16, color: '#a1a1aa', lineHeight: 1.8, margin: '0 0 16px' }}>
              <strong style={{ color: '#e4e4e7' }}>Mêmes délais, même qualité quel que soit le mode.</strong> Présentiel pertinent pour le cadrage à Montpellier (Antigone, Comédie, Port Marianne) ou à Cap Alpha. Distanciel pour le build (60 à 70 % du projet) gagne du temps à tout le monde.
            </p>
...
function MetierMockup({ index }: { index: number }) {
  const mockups = [
    // Service client SaaS FrenchTech
    <div style={{ background: '#09090b', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.18)', border: `1px solid ${AC}30` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
        <span style={{ fontSize: 12, fontWeight: 800, color: '#3f3f46', textTransform: 'uppercase', letterSpacing: '.1em' }}>Scale-up FrenchTech · Cap Alpha</span>
      ...
      {[{ l: 'N1 absorbé en autonomie', v: '70 %' }, { l: 'Temps de première réponse', v: '4 min' }, { l: 'CSAT', v: '+12 pts' }, { l: '0 départ équipe support', v: '4 embauches annulées' }].map((r, i) => (
    ...
    // Marketing content agences / scale-up
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>Editeur SaaS B2B · Montpellier</div>
      {[{ l: 'Articles SEO / mois', v: '×4' }, { l: 'Trafic organique', v: '+140 %' }, { l: 'Budget agence annulé', v: '60 k€/an' }, { l: 'Délai 1er article', v: '5 jours' }].map((r, i) => (
    ...
    // Finance cabinets Montpellier
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 10 }}>Cabinet comptable · Montpellier</div>
    ...
    // Achats biotech Languedoc
    <div style={{ background: '#fff', borderRadius: 14, padding: 20, boxShadow: '0 4px 28px rgba(0,0,0,.09)', border: '1px solid #e4e4e7' }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 14 }}>ETI biotech · Occitanie Méditerranée</div>
...
const metiers = [
  {
    n: '01', href: '/agent-ia/service-client/', label: 'Service client (SaaS FrenchTech, e-commerce)', tag: 'Agent IA Service client →',
    desc: "Les scale-up FrenchTech Méditerranée (SaaS B2B, plateformes), les e-commerces régionaux et les acteurs tech à Cap Alpha croulent sous les tickets répétitifs. Notre agent IA absorbe 70 % du N1 en autonomie. Cas signature : scale-up SaaS B2B 8 000 clients PME, CSAT +12 points en 3 mois, temps de première réponse de 18h à 4 minutes.",
    pub: "Scale-up FrenchTech Méditerranée · E-commerces Occitanie · SaaS B2B Montpellier · Plateformes tech Cap Alpha",
    reverse: false,
  },
  {
    n: '02', href: '/agent-ia/marketing/', label: 'Marketing et content (agences digitales, scale-up)', tag: 'Agent IA Marketing →',
    desc: "Les agences digitales montpelliéraines, les scale-up FrenchTech et les acteurs tech doivent produire un contenu multi-canal cohérent avec leur ton de marque. Notre agent IA marketing produit articles SEO, posts LinkedIn, newsletters segmentées. Cas type : éditeur SaaS B2B, content ×4 sans embauche, trafic organique +140 %.",
    pub: "Agences digitales Montpellier · Scale-up FrenchTech · Editeurs SaaS · Acteurs tech Cap Alpha",
    reverse: true,
  },
  {
    n: '03', href: '/agent-ia/finance/', label: 'Finance et comptabilité (cabinets pro Montpellier)', tag: 'Agent IA Finance →',
    desc: "Les cabinets d'expertise comptable montpelliérains (forte densité Antigone, Comédie, Millénaire) et les directions financières d'ETI régionales absorbent 60 à 80 % de saisie répétitive (factures fournisseurs, rapprochement bancaire, écritures). Cas signature : cabinet d'expertise comptable, ×2 capacité en 4 mois, souveraineté Mistral France.",
    pub: "Cabinets comptables Antigone et Comédie · Directions financières ETI Occitanie · Compta biotech · Finance scale-up",
    reverse: false,
  },
  {
    n: '04', href: '/agent-ia/achats/', label: 'Achats (biotech, agroalimentaire premium, viticulture Languedoc)', tag: 'Agent IA Achats →',
    desc: "Les directions achats des biotech montpelliéraines (CHU, Institut Méditerranéen de Cancérologie), des acteurs agroalimentaires premium Languedoc et de la viticulture haut de gamme gèrent des panels fournisseurs spécialisés avec exigences fortes. Notre agent IA combine sourcing accéléré, analyse devis pondérée et vigilance financière. Cas signature : ETI, +4 % d'économies = 1,2 M€.",
    pub: "Biotech Cap Alpha et CHU Montpellier · Agroalimentaire Languedoc · Viticulture haut de gamme · ETI industrielles Occitanie",
    reverse: true,
  },
];

function MetiersMontpellier() {
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto' }}>
        <div style={{ marginBottom: 56 }}>
          <H2 style={{ marginBottom: 12 }}>L'IA transforme chaque métier montpelliérain</H2>
          <p style={{ fontSize: 16, color: '#52525b', maxWidth: 640, lineHeight: 1.7 }}>
            Quatre métiers où nos agents IA ont déjà transformé le quotidien de PME et ETI montpelliéraines, du technopôle Cap Alpha au CHU et aux scale-up FrenchTech Méditerranée. Pour la liste complète, voir notre <a href="/agent-ia/" style={{ color: AC, fontWeight: 700, textDecoration: 'none' }}>hub agents IA par fonction</a>.
          </p>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 56 }}>
          {metiers.map((m, i) => (
            <div key={i} className={`mpl-metier-row${m.reverse ? ' mpl-metier-rev' : ''}`}
              ...
              <div style={{ order: m.reverse ? 2 : 1 }}>
                ...
                <div style={{ padding: '10px 16px', borderRadius: 10, background: '#f0f7ff', border: `1px solid ${AC}15`, marginBottom: 20 }}>
                  <div style={{ fontSize: 10, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: 4 }}>Public type Montpellier / Occitanie Méditerranée</div>
              ...
              <div className="mpl-mockup-col" style={{ order: m.reverse ? 1 : 2 }}>
        ...
        <div style={{ marginTop: 64, overflow: 'hidden', borderTop: '1px solid #e4e4e7', paddingTop: 32 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', gap: 10, animation: 'mpl-ticker 60s linear infinite', width: 'max-content' }}>
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 1060, margin: '0 auto', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .6s ease' }}>
        <div style={{ fontSize: 12, fontWeight: 800, color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '.14em', marginBottom: 24 }}>Cas client Occitanie · Anonymisé</div>
        <H2 style={{ marginBottom: 20 }}>Scale-up FrenchTech Méditerranée : 70 % du support N1 absorbé en 4 semaines</H2>

        <div style={{ display: 'inline-flex', flexWrap: 'wrap', gap: 6, marginBottom: 40, padding: '6px 14px', borderRadius: 9999, background: '#f4f4f5' }}>
          {['Scale-up FrenchTech B2B', '90 collaborateurs', 'Cap Alpha Montpellier', '2025-2026', 'cas anonymisé'].map((t) => (
        ...
        <div className="mpl-cas-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.8fr', gap: 48, alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { v: '70 %', l: 'du N1 absorbé en autonomie', hero: true },
              { v: '4 min', l: 'temps de première réponse (vs 18h)', hero: false },
              { v: '+12 pts', l: 'CSAT en 3 mois', hero: false },
          ...
          <div>
            <h3 style={{ fontSize: 18, fontWeight: 800, color: '#09090b', marginBottom: 16, lineHeight: 1.3 }}>200 tickets/jour, 70 % répétitifs : la direction commerciale s'inquiétait pour le CSAT.</h3>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 20 }}>
              La scale-up FrenchTech montpelliéraine (plateforme SaaS B2B utilisée par des PME françaises et européennes) traitait 200 tickets support par jour avec 12 agents. 70 % de tickets répétitifs. La direction commerciale s'inquiétait de la dégradation CSAT liée aux délais de réponse. Recruter aurait coûté 240 k€/an sans résoudre le problème de fond.
            </p>
            <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.85, marginBottom: 28 }}>
              Agent IA Althoce intégré à Zendesk, déployé en 4 semaines en mode hybride (cadrage présentiel à Cap Alpha, build distanciel). Aujourd'hui, l'éditeur a redéployé son budget recrutement sur 2 customer success managers à plus forte valeur ajoutée. CSAT +12 points. 0 départ dans l'équipe.
            </p>
            ...
            <div style={{ padding: '20px 24px', borderRadius: 14, background: '#f0f7ff', border: `1px solid ${AC}20`, marginBottom: 24 }}>
              <p style={{ fontSize: 15, color: '#1e3a5f', lineHeight: 1.75, margin: 0, fontStyle: 'italic' }}>
                "On a évité 4 recrutements. Le CSAT a remonté en 3 mois. Les agents se concentrent enfin sur les vrais sujets."
              </p>
              <div style={{ marginTop: 10, fontSize: 13, fontWeight: 700, color: '#52525b' }}>Directeur produit · Scale-up FrenchTech Méditerranée</div>
            </div>
...
// ── FAQ ───────────────────────────────────────────────────────
const faqMontpellier = [
  {
    q: "Présentiel ou distanciel à Montpellier : quelle différence ?",
    a: "Aucune différence qualité ni délais. Présentiel pertinent à Montpellier (Antigone, Comédie, Cap Alpha, Port Marianne), Pérols-Lattes pour le cadrage et les ateliers. Build en distanciel structuré avec points hebdomadaires de 30 minutes.",
  },
  {
    q: "Avez-vous un bureau permanent à Montpellier ?",
    a: "Pas de bureau permanent. Espaces partenaires à Cap Alpha et sur l'Antigone pour les RDV présentiels. Déplacements réguliers dans la métropole et en Occitanie côté Méditerranée (Nîmes, Béziers, Sète sur demande).",
  },
  {
    q: "Proposez-vous des formations IA pour mes équipes montpelliéraines ?",
    a: "Oui. Ateliers 4h à 21h, présentiel Montpellier (Cap Alpha ou vos locaux), Occitanie Méditerranée ou distanciel synchrone. Programme adapté par métier : scale-up FrenchTech, biotech, agences digitales, cabinets comptables.",
  },
  {
    q: "Avez-vous une expertise sur la biotech montpelliéraine (CHU, Institut Méditerranéen de Cancérologie) ?",
    a: "Oui. Conformité réglementaire HAS, ANSM, EMA. Souveraineté Mistral hébergé France obligatoire pour les données de recherche clinique et patients. Cas types : agents IA gestion documentaire pharma, veille réglementaire, vigilance fournisseurs critiques.",
  },
  {
    q: "Mes données restent-elles en France ?",
    a: "Oui par défaut. Mistral hébergé France (OVH, Scaleway). Particulièrement strict pour biotech (données patients, secret recherche), viticulture Languedoc premium (secret commercial) et agroalimentaire méditerranéen (normes sanitaires européennes).",
  },
  {
    q: "Avez-vous des clients en Occitanie côté Méditerranée ?",
    a: "Oui. Scale-up FrenchTech Méditerranée, biotech Cap Alpha, cabinets d'expertise comptable centre-ville, agences digitales, viticulture Languedoc premium. Notre cas signature service client (CSAT +12 points, 70 % N1 absorbé) est directement transposable au tissu régional montpelliérain.",
  },
];

function FAQMontpellier() {
  return (
    <section id="faq" style={{ padding: '96px 24px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 52 }}>
          <H2 style={{ marginBottom: 12 }}>Questions fréquentes : Althoce à Montpellier et en Occitanie</H2>
          <p style={{ fontSize: 16, color: '#52525b' }}>Réponses directes aux questions que posent nos prospects montpelliérains avant la prise de contact.</p>
        </div>
        <FAQAccordion items={faqMontpellier} />
      </div>
    </section>
  );
}
...
function Souverainete() {
  ...
  return (
    <section ref={ref} style={{ padding: '96px 24px', background: '#09090b', borderTop: '1px solid #1a1a1a' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        <div className="mpl-split-rev" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'center' }}>
    ...
    <section ref={ref} style={{ padding: '96px 24px', background: '#fff', borderTop: '1px solid #e4e4e7' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all .7s ease' }}>
        ...
        <H2 style={{ marginBottom: 20 }}>
          Prêt à déployer votre premier agent IA<br /><span style={{ color: AC }}>à Montpellier ou en Occitanie ?</span>
        </H2>
        <p style={{ fontSize: 16, color: '#8a8a95', lineHeight: 1.75, marginBottom: 40, maxWidth: 520, margin: '0 auto 40px' }}>
          Un échange de 30 minutes suffit à identifier le cas d'usage le plus impactant. Repartez avec une feuille de route et un devis ferme sous 5 jours. Présentiel à Montpellier ou Cap Alpha, ou distanciel, que l'on travaille ensemble ou non.
        </p>
...
// ── CSS ───────────────────────────────────────────────────────
const globalStyles = `
  @keyframes mpl-drift { 0%,100%{transform:translate(0,0) scale(1)}50%{transform:translate(3%,4%) scale(1.06)} }
  @keyframes mpl-ticker { from{transform:translateX(0)}to{transform:translateX(-50%)} }

  @media (max-width:860px) {
    .mpl-hero-grid { grid-template-columns:1fr !important; }
    .mpl-map-col { display:none !important; }
    .mpl-split-rev { grid-template-columns:1fr !important; }
    .mpl-cas-grid { grid-template-columns:1fr !important; }
    .mpl-metier-row { grid-template-columns:1fr !important; }
    .mpl-metier-rev > div { order:unset !important; }
    .mpl-mockup-col { display:none !important; }
    .mpl-grid4 { grid-template-columns:repeat(2,1fr) !important; }
  }
  @media (max-width:560px) {
    .mpl-grid4 { grid-template-columns:1fr !important; }
  }
`;

export default function AgenceIAMontpellierPageClient() {
  return (
    <main>
